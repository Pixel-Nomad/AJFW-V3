...
Config.oldESX = false -- Nothing to do with aj / Essentially when set to true it disables the check of if player can carry item
...
RegisterNetEvent('aj-fishing:notify')
AddEventHandler('aj-fishing:notify', function(title, message, msgType)

...
local hiddenstart = vector3(1128.98, 2125.26, 55.54) -- Change this to whatever location you want. This is server side to prevent people from dumping the coords
local boarspawn = {
	[1] = {
...
AJFW.Functions.CreateCallback('coke:ingredient', function(source, cb)
	...
	local lighter = Ply.Functions.GetItemByName("	")

RegisterNetEvent('aj-chopshop:wheelanimation')
AddEventHandler('aj-chopshop:wheelanimation', function()
    TriggerEvent('animations:client:EmoteCommandStart', {"mechanic3"})
	AJFW.Functions.Progressbar("wheel", Config.Locale["Wheel"],'black', 7000, false, true, {
...
RegisterNetEvent('aj-chopshop:dooranimation')
AddEventHandler('aj-chopshop:dooranimation', function()
    TriggerEvent('animations:client:EmoteCommandStart', {"mechanic4"})
	AJFW.Functions.Progressbar("Door1", Config.Locale["Door1"],'black', (4000), false, true, {
	    disableMovement = true,
		disableCarMovement = true,
		disableMouse = false,
		disableCombat = true,
	...
	AJFW.Functions.Progressbar("Door2", Config.Locale["Door2"],'black', (4000), false, true, {
		disableMovement = true,
		disableCarMovement = true,
		disableMouse = false,
		disableCombat = true,
...
RegisterNetEvent('aj-chopshop:trunkanimation')
AddEventHandler('aj-chopshop:trunkanimation', function()
    TriggerEvent('animations:client:EmoteCommandStart', {"mechanic"})
	AJFW.Functions.Progressbar("Trunk1", Config.Locale["searching"],'black', (4000), false, true, {
	    disableMovement = true,
		disableCarMovement = true,
		disableMouse = false,
		disableCombat = true,
	...
	Citizen.Wait(4500)
	TriggerEvent('animations:client:EmoteCommandStart', {"mechanic4"})
	AJFW.Functions.Progressbar("Hood1", Config.Locale["Door1"],'black', (4000), false, true, {
	    disableMovement = true,
		disableCarMovement = true,
		disableMouse = false,
		disableCombat = true,
	...
	Citizen.Wait(4500)
	TriggerEvent('animations:client:EmoteCommandStart', {"pull"})
	AJFW.Functions.Progressbar("Hood2", Config.Locale["Door2"],'black', (4000), false, true, {
		disableMovement = true,
		disableCarMovement = true,
		disableMouse = false,
		disableCombat = true,
...
RegisterNetEvent('aj-chopshop:hoodanimation')
AddEventHandler('aj-chopshop:hoodanimation', function()
    TriggerEvent('animations:client:EmoteCommandStart', {"mechanic4"})
	AJFW.Functions.Progressbar("Hood1", Config.Locale["Door1"],'black', (4000), false, true, {
	    disableMovement = true,
		disableCarMovement = true,
...
RegisterNetEvent('aj-chopshop:wheelchopanim')
AddEventHandler('aj-chopshop:wheelchopanim', function()
	local ped = PlayerPedId()
	AJFW.Functions.Progressbar("wheel", Config.Locale["chopwheel"],'black', 13000, false, true, {
		disableMovement = true,
		disableCarMovement = true,
		disableMouse = false,
		disableCombat = true,
...
RegisterNetEvent('aj-chopshop:doorchopanim')
AddEventHandler('aj-chopshop:doorchopanim', function()
	local ped = PlayerPedId()    
	AJFW.Functions.Progressbar("door", Config.Locale["chopdoor"],'black', 13000, false, true, {
		disableMovement = true,
		disableCarMovement = true,
		disableMouse = false,
		disableCombat = true,
...
RegisterNetEvent('aj-chopshop:hoodchopanim')
AddEventHandler('aj-chopshop:hoodchopanim', function()
	local ped = PlayerPedId()    
	AJFW.Functions.Progressbar("hood", Config.Locale["chophood"],'black', 12500, false, true, {
		disableMovement = true,
		disableCarMovement = true,
		disableMouse = false,
		disableCombat = true,
...
RegisterNetEvent('aj-chopshop:trunkchopanim')
AddEventHandler('aj-chopshop:trunkchopanim', function()
	local ped = PlayerPedId()
	AJFW.Functions.Progressbar("trunk", Config.Locale["choptrunk"],'black', 12500, false, true, {
		disableMovement = true,
		disableCarMovement = true,
		disableMouse = false,
		disableCombat = true,

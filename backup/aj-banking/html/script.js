const bankingApp = Vue.createApp({
    ...
    methods: {
        ...
        withdrawMoney() {
            ...
            axios
                .post("https://aj-banking/withdraw", {
        ...
        internalTransfer() {
            ...
            axios
                .post("https://aj-banking/internalTransfer", {
        ...
        externalTransfer() {
            ...
            axios
                .post("https://aj-banking/externalTransfer", {
        ...
        orderDebitCard() {
            ...
            axios
                .post("https://aj-banking/orderCard", {
                    pin: this.debitPin,
                })
                .then((response) => {
                    if (response.data.success) {
        ...
        openAccount() {
            ...
            axios
                .post("https://aj-banking/openAccount", {
        ...
        renameAccount() {
            ...
            axios
                .post("https://aj-banking/renameAccount", {
        ...
        deleteAccount() {
            ...
            axios
                .post("https://aj-banking/deleteAccount", {
        ...
        removeUserFromAccount() {
            ...
            axios
                .post("https://aj-banking/removeUser", {
                    accountName: this.manageAccountName.name,
                    userName: this.manageUserName,
                })
                .then((response) => {

        ...
        while true do
            ...
            if isDriver then
                ...
                if drivingDistance[plate] then
                    TriggerServerEvent('aj-mechanicjob:server:updateDrivingDistance', plate, drivingDistance[plate].distance)
                    TriggerServerEvent('aj-mechanicjob:server:updateVehicleComponents', plate, vehicleComponents[plate])
                end
                plate = nil
                vehicle = nil
                break

...
CreateThread(function()
    ...
    framework = GetResourceState('es_extended') == 'started' and 'esx' or GetResourceState('aj-base') == 'started' and 'aj' or nil
...
AddEventHandler('aj-elevator:goToFloor', function(data)
...
AddEventHandler('aj-elevator:noAccess', function()
    lib.notify({
        title = 'No Access',
...
AddEventHandler('aj-elevator:openMenu', function(data)

...
local resourceName = "aj-elevators"

if Config.checkForUpdates then
    CreateThread(function()
        if GetCurrentResourceName() ~= "aj-elevators" then
            resourceName = "aj-elevators (" .. GetCurrentResourceName() .. ")"
        end
    end)

    CreateThread(function()
        while true do
            PerformHttpRequest("https://api.github.com/repos/wasabirobby/wasabi_elevators/releases/latest", CheckVersion, "GET")
            Wait(3600000)
        end
    end)
    ...
    GetRepoInformations = function()
        ...
        PerformHttpRequest("https://api.github.com/repos/wasabirobby/aj-elevators/releases/latest", function(err, response, headers)
            if err == 200 then
                ...
                repoURL = "https://github.com/wasabirobby/aj-elevators"
            end
        end, "GET")

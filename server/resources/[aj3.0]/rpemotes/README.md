...
- Persistent Walkstyles via client KVP 🚶‍♂️ - Standalone, aj-base and ESX support!
...
- aj-base Framework & SQL Keybinding Support ⚙️
...
* aj-base server owners, set `Framework = 'aj-base'` in the config file, otherwise leave it as false.
...
- Thank you [Chico](https://forum.cfx.re/u/chico) for implementing natives to reapply persistent moods and walkstyles for ESX and aj-base frameworks

...
Config = {
    ...
    Framework = 'aj-base', -- Used for few framework-dependent things. Accepted values: 'aj-base', false.
	...
	-- HANDS UP OPTIONS 
    HandsupEnabled = false, -- You can enable / disable the handsup here / change the keybind. It is currently set to Y however disabled by default as to not conflict with aj-base servers.
	...
	-- POINTING OPTIONS
    PointingEnabled = false, -- You can enable / disable the finger pointing here / change the keybind. It is currently set to B however disabled by default as to not conflict with aj-base servers.

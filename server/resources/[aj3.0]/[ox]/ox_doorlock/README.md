...
Door management resource, with compatibility for ox_core, aj-base, and es_extended.  
...
### [ox_target](https://github.com/overextended/ox_target) (preferred) or [qtarget](https://github.com/overextended/qtarget) (deprecated) or [aj-target](https://github.com/qbcore-framework/aj-target)

...
AJFW.Functions.CreateCallback('jim-mechanic:GetNosLoaded', function(source, cb) cb(VehicleNitrous) end)
...
AJFW.Functions.CreateUseableItem("noscolour", function(source, item) TriggerClientEvent("jim-mechanic:client:NOS:rgbORhex", source) end)
...
--Callback to send Database info to Client
AJFW.Functions.CreateCallback('jim-mechanic:GetNosColour', function(source, cb) cb(nosColour) end)

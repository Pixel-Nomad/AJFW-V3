...
local xenonColour = {}
----Commands
--[[AJFW.Commands.Add("test", "", {}, false, function(source, args) TriggerServerEvent('jim-mechanic:server:LoadNitrous', trim(GetVehicleNumberPlateText(GetVehiclePedIsIn(source)))) end)]]

AJFW.Commands.Add("preview", Loc[Config.Lan]["servfunction"].checkmods, {}, false, function(source) TriggerClientEvent("jim-mechanic:client:Preview:Menu", source) end)
AJFW.Commands.Add("checkveh", "Check Performance", {}, false, function(source) TriggerClientEvent("jim-mechanic:client:cuscheck", source) end)
AJFW.Commands.Add("showodo", "Odometer", {}, false, function(source) TriggerClientEvent("jim-mechanic:ShowOdo", source) end)
AJFW.Commands.Add("checkdamage", Loc[Config.Lan]["servfunction"].checkdamage, {}, false, function(source) TriggerClientEvent("jim-mechanic:client:Repair:Check", source, true) end)
AJFW.Commands.Add("checkmods", Loc[Config.Lan]["servfunction"].checkmods, {}, false, function(source) TriggerClientEvent("jim-mechanic:client:Menu:List", source) end)
AJFW.Commands.Add("flipvehicle", Loc[Config.Lan]["servfunction"].flipvehicle, {}, false, function(source)	TriggerClientEvent("jim-mechanic:flipvehicle", source) end)
AJFW.Commands.Add("togglesound", Loc[Config.Lan]["servfunction"].togglesound, {}, false, function(source)	TriggerClientEvent("jim-mechanic:togglesound", source) end)
AJFW.Commands.Add("cleancar", Loc[Config.Lan]["servfunction"].cleancar, {}, false, function(source) TriggerClientEvent("jim-mechanic:client:cleanVehicle", source, true) end)
AJFW.Commands.Add("hood", Loc[Config.Lan]["servfunction"].hood, {}, false, function(source) TriggerClientEvent("jim-mechanic:client:openDoor", source, 4) end)
AJFW.Commands.Add("trunk", Loc[Config.Lan]["servfunction"].trunk, {}, false, function(source) TriggerClientEvent("jim-mechanic:client:openDoor", source, 5) end)
AJFW.Commands.Add("door", Loc[Config.Lan]["servfunction"].door, {{name="0-3", help="Door ID"}}, false, function(source, args) TriggerClientEvent("jim-mechanic:client:openDoor", source, args[1]) end)
AJFW.Commands.Add("seat", Loc[Config.Lan]["servfunction"].seat, {{name="id", help="Seat ID"}}, false, function(source, args) TriggerClientEvent("jim-mechanic:seat", source, args[1]) end)

AJFW.Functions.CreateCallback("jim-mechanic:checkVehicleOwner", function(source, cb, plate)
...
AJFW.Functions.CreateCallback("jim-mechanic:distGrab", function(source, cb, plate)
...
AJFW.Functions.CreateCallback("jim-mechanic:checkCash", function(source, cb)
...
AJFW.Functions.CreateCallback('jim-mechanic:mechCheck', function(source, cb)
	local dutyList = {}
...
AJFW.Functions.CreateCallback('jim-mechanic:GetXenonColour', function(source, cb) cb(xenonColour) end)

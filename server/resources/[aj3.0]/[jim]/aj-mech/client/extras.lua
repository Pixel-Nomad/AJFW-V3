...
RegisterNetEvent('jim-mechanic:quickrepair', function()
	...
	if DoesEntityExist(vehicle) then
		...
		if repaireng or repairbody then
			...
			AJFW.Functions.Progressbar("drink_something", Loc[Config.Lan]["repair"].applyduct, 10000, false, true, { disableMovement = true, disableCarMovement = true, disableMouse = false, disableCombat = false, },
...
RegisterNetEvent("jim-mechanic:flipvehicle", function()
	...
	if DoesEntityExist(vehicle) then
		AJFW.Functions.Progressbar("accepted_key", Loc[Config.Lan]["extras"].flipping, 12000, false, true, { disableMovement = true, disableCarMovement = true, disableMouse = false,	disableCombat = false, },
		{ animDict = "missfinale_c2ig_11", anim = "pushcar_offcliff_f",	flags = 17, }, {}, {}, function()
			ajlog("used `/flipvehicle`")
			emptyHands(playerPed)
...
RegisterNetEvent("jim-mechanic:seat", function(seat)
	...
	local HasHarnass = exports['aj-smallresources']:HasHarness()
								...
								if IsPedInAnyVehicle(PlayerPedId(), true) then
									...
									if not IsVehicleStopped(GetVehiclePedIsIn(ped)) then
										...
										if DistAdd >= 3000 then
											if useMechJob() then
												local mechDamages = {
													["radiator"] = (math.floor(exports['aj-mechanicjob']:GetVehicleStatus(plate, "radiator"))+0.0 or 100),
													["axle"] = (math.floor(exports['aj-mechanicjob']:GetVehicleStatus(plate, "axle"))+0.0 or 100),
													["brakes"] = (math.floor(exports['aj-mechanicjob']:GetVehicleStatus(plate, "brakes"))+0.0 or 100),
									...
									local lights = ""
										...
										if Config.Debug then
											...
											if useMechJob() then
												...
												"<br>"..Loc[Config.Lan]["repair"].radiator..": "..math.floor(exports['aj-mechanicjob']:GetVehicleStatus(plate, "radiator") or 100).."%<br>"..nosBar(math.floor(exports['aj-mechanicjob']:GetVehicleStatus(plate, "radiator") or 100)).." "..
												"<br>"..Loc[Config.Lan]["repair"].driveshaft..": "..math.floor(exports['aj-mechanicjob']:GetVehicleStatus(plate, "axle") or 100).."%<br>"..nosBar(math.floor(exports['aj-mechanicjob']:GetVehicleStatus(plate, "axle") or 100)).." "..
												"<br>"..Loc[Config.Lan]["repair"].brakes..": "..math.floor(exports['aj-mechanicjob']:GetVehicleStatus(plate, "brakes") or 100).."%<br>"..nosBar(math.floor(exports['aj-mechanicjob']:GetVehicleStatus(plate, "brakes") or 100)).." "..
												"<br>"..Loc[Config.Lan]["repair"].clutch..": "..math.floor(exports['aj-mechanicjob']:GetVehicleStatus(plate, "clutch") or 100).."%<br>"..nosBar(math.floor(exports['aj-mechanicjob']:GetVehicleStatus(plate, "clutch") or 100)).." "..
												"<br>"..Loc[Config.Lan]["repair"].tank..": "..math.floor(exports['aj-mechanicjob']:GetVehicleStatus(plate, "fuel") or 100).."%<br>"..nosBar(math.floor(exports['aj-mechanicjob']:GetVehicleStatus(plate, "fuel") or 100))
											end
											odotext = odotext..
											...
											if useMechJob() then
												for k, v in pairs({"radiator", "brakes", "axle", "clutch"}) do
													if Config.OdoIconsToShow[v] then
														if exports['aj-mechanicjob']:GetVehicleStatus(plate, v) then
															if exports['aj-mechanicjob']:GetVehicleStatus(plate, v) > 70 then
															...
															elseif exports['aj-mechanicjob']:GetVehicleStatus(plate, v) < 70 and exports['aj-mechanicjob']:GetVehicleStatus(plate, v) > 45 then
															...
															elseif exports['aj-mechanicjob']:GetVehicleStatus(plate, v) < 45 then

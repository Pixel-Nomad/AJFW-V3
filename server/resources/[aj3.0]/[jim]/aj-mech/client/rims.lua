...
RegisterNetEvent('aj-mech:client:Rims:Apply', function(data)
	...
	AJFW.Functions.Progressbar("drink_something", Loc[Config.Lan]["rims"].installing, time, false, true, { disableMovement = true, disableCarMovement = true, disableMouse = false, disableCombat = false, },

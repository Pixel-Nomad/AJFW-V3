...
Config.Locations = {
	...
	{	
		job = "mechanic",
		zones = {
			vector2(-224.97221374512, -1314.6904296875),
			vector2(-230.42877197266, -1314.7520751953),
			vector2(-231.52426147461, -1341.6960449219),
			vector2(-191.865234375, -1339.9182128906),
			vector2(-191.83447265625, -1314.5863037109)
		},
		autoClock = { enter = false, exit = false, },
		stash = { { coords = vector4(-206.74, -1339.34, 31.3, 169.81), w = 3.6, d = 0.8, }, },
		store = { { coords = vector4(-224.97, -1315.27, 31.3, 91.42), w = 3.60, d = 0.8 }, },
		crafting = { { coords = vector4(-214.82, -1339.74, 31.46, 90.0), w = 2.8, d = 1.5 }, },
		clockin = { { coords = vector4(-198.1, -1317.23, 31.24, 268.47), prop = false }, },
		manualRepair = { { coords = vector4(-200.28, -1311.62, 31.3, 0.0), prop = true, } },
		garage = { 
			spawn = vector4(-182.74, -1317.61, 30.63, 357.23),
			out = vector4(-190.62, -1311.57, 31.3, 0.0),
			list = { "towtruck", "panto", "slamtruck", "cheburek", "utillitruck3" },
			prop = true 
		},
		payments = { coords = vector4(-197.89, -1317.91, 31.04, 269.02),
		img = "<center><p><img src=https://static.wikia.nocookie.net/gtawiki/images/b/be/BennysOriginalMotorWorks-GTAO-Logo.png width=150px></p>",
		prop = true },

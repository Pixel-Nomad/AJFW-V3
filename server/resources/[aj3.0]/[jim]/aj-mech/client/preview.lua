...
local function printDifferences(vehicle, properties, newproperties)
	ajlog("Finished Previewing: [**"..trim(GetVehicleNumberPlateText(vehicle)).."**]")
	...
	if properties["color1"] ~= newproperties["color1"] then
		if type(newproperties["color1"]) ~= "table" then
			...
			vehlist[#vehlist+1] = Loc[Config.Lan]["paint"].primary.." - [ "..v.name.." ("..Loc[Config.Lan]["paint"].metallic..") ]" modlist[#modlist+1] = {['type'] = v.name.." ("..Loc[Config.Lan]["paint"].metallic..")", ["item"] = Loc[Config.Lan]["paint"].primary.." - "..AJFW.Shared.Items["paintcan"].label } end end
			for k, v in pairs(Loc[Config.Lan].vehicleResprayOptionsMatte) do if newproperties["color1"] == v.id then
			vehlist[#vehlist+1] = Loc[Config.Lan]["paint"].primary.." - [ "..v.name.." ("..Loc[Config.Lan]["paint"].matte..") ]" modlist[#modlist+1] = {['type'] = v.name.." ("..Loc[Config.Lan]["paint"].matte..")", ["item"] = Loc[Config.Lan]["paint"].primary.." - "..AJFW.Shared.Items["paintcan"].label } end end
			for k, v in pairs(Loc[Config.Lan].vehicleResprayOptionsMetals) do if newproperties["color1"] == v.id then
			vehlist[#vehlist+1] = Loc[Config.Lan]["paint"].primary.." - [ "..v.name.." ("..Loc[Config.Lan]["paint"].metals..") ]" modlist[#modlist+1] = {['type'] = v.name.." ("..Loc[Config.Lan]["paint"].metals..")", ["item"] = Loc[Config.Lan]["paint"].primary.." - "..AJFW.Shared.Items["paintcan"].label } end end
			for k, v in pairs(Loc[Config.Lan].vehicleResprayOptionsChameleon) do if newproperties["color1"] == v.id then
			vehlist[#vehlist+1] = Loc[Config.Lan]["paint"].primary.." - [ "..v.name.." ("..Loc[Config.Lan]["paint"].chameleon..") ]" modlist[#modlist+1] = {['type'] = v.name.." ("..Loc[Config.Lan]["paint"].chameleon..")", ["item"] = Loc[Config.Lan]["paint"].primary.." - "..AJFW.Shared.Items["paintcan"].label } end end
		end
	end
	if properties["color2"] ~= newproperties["color2"] then
		if type(newproperties["color2"]) ~= "table" then
			...
			vehlist[#vehlist+1] = Loc[Config.Lan]["paint"].secondary.." - [ "..v.name.." ("..Loc[Config.Lan]["paint"].metallic..") ]" modlist[#modlist+1] = {['type'] = v.name.." ("..Loc[Config.Lan]["paint"].metallic..")", ["item"] = Loc[Config.Lan]["paint"].secondary.." - "..AJFW.Shared.Items["paintcan"].label } end end
			for k, v in pairs(Loc[Config.Lan].vehicleResprayOptionsMatte) do if newproperties["color2"] == v.id then
			vehlist[#vehlist+1] = Loc[Config.Lan]["paint"].secondary.." - [ "..v.name.." ("..Loc[Config.Lan]["paint"].matte..") ]" modlist[#modlist+1] = {['type'] = v.name.." ("..Loc[Config.Lan]["paint"].matte..")", ["item"] = Loc[Config.Lan]["paint"].secondary.." - "..AJFW.Shared.Items["paintcan"].label } end end
			for k, v in pairs(Loc[Config.Lan].vehicleResprayOptionsMetals) do if newproperties["color2"] == v.id then
			vehlist[#vehlist+1] = Loc[Config.Lan]["paint"].secondary.." - [ "..v.name.." ("..Loc[Config.Lan]["paint"].metals..") ]" modlist[#modlist+1] = {['type'] = v.name.." ("..Loc[Config.Lan]["paint"].metals..")", ["item"] = Loc[Config.Lan]["paint"].secondary.." - "..AJFW.Shared.Items["paintcan"].label } end end
			for k, v in pairs(Loc[Config.Lan].vehicleResprayOptionsChameleon) do if newproperties["color2"] == v.id then
			vehlist[#vehlist+1] = Loc[Config.Lan]["paint"].secondary.." - [ "..v.name.." ("..Loc[Config.Lan]["paint"].chameleon..") ]" modlist[#modlist+1] = {['type'] = v.name.." ("..Loc[Config.Lan]["paint"].chameleon..")", ["item"] = Loc[Config.Lan]["paint"].secondary.." - "..AJFW.Shared.Items["paintcan"].label } end end
		end
	end
	if properties["pearlescentColor"] ~= newproperties["pearlescentColor"] then
		...
		vehlist[#vehlist+1] = Loc[Config.Lan]["paint"].pearl.." - [ "..v.name.." ("..Loc[Config.Lan]["paint"].metallic..") ]" modlist[#modlist+1] = {['type'] = v.name.." ("..Loc[Config.Lan]["paint"].metallic..")", ["item"] = Loc[Config.Lan]["paint"].pearl.." - "..AJFW.Shared.Items["paintcan"].label } end end
		for k, v in pairs(Loc[Config.Lan].vehicleResprayOptionsMatte) do if newproperties["pearlescentColor"] == v.id then
		vehlist[#vehlist+1] = Loc[Config.Lan]["paint"].pearl.." - [ "..v.name.." ("..Loc[Config.Lan]["paint"].matte..") ]" modlist[#modlist+1] = {['type'] = v.name.." ("..Loc[Config.Lan]["paint"].matte..")", ["item"] = Loc[Config.Lan]["paint"].pearl.." - "..AJFW.Shared.Items["paintcan"].label } end end
		for k, v in pairs(Loc[Config.Lan].vehicleResprayOptionsMetals) do if newproperties["pearlescentColor"] == v.id then
		vehlist[#vehlist+1] = Loc[Config.Lan]["paint"].pearl.." - [ "..v.name.." ("..Loc[Config.Lan]["paint"].metals..") ]" modlist[#modlist+1] = {['type'] = v.name.." ("..Loc[Config.Lan]["paint"].metals..")", ["item"] = Loc[Config.Lan]["paint"].pearl.." - "..AJFW.Shared.Items["paintcan"].label } end end
		for k, v in pairs(Loc[Config.Lan].vehicleResprayOptionsChameleon) do if newproperties["pearlescentColor"] == v.id then
		vehlist[#vehlist+1] = Loc[Config.Lan]["paint"].pearl.." - [ "..v.name.." ("..Loc[Config.Lan]["paint"].chameleon..") ]" modlist[#modlist+1] = {['type'] = v.name.." ("..Loc[Config.Lan]["paint"].chameleon..")", ["item"] = Loc[Config.Lan]["paint"].pearl.." - "..AJFW.Shared.Items["paintcan"].label } end end
		end
	if properties["wheelColor"] ~= newproperties["wheelColor"] then
		...
		vehlist[#vehlist+1] = Loc[Config.Lan]["paint"].wheel.." Color - [ "..v.name.." ("..Loc[Config.Lan]["paint"].metallic..") ]" modlist[#modlist+1] = {['type'] = v.name.." ("..Loc[Config.Lan]["paint"].metallic..")", ["item"] = Loc[Config.Lan]["paint"].wheel.." - "..AJFW.Shared.Items["paintcan"].label } end end
		for k, v in pairs(Loc[Config.Lan].vehicleResprayOptionsMatte) do if newproperties["wheelColor"] == v.id then
		vehlist[#vehlist+1] = Loc[Config.Lan]["paint"].wheel.."Color - [ "..v.name.." ("..Loc[Config.Lan]["paint"].matte..") ]" modlist[#modlist+1] = {['type'] = v.name.." ("..Loc[Config.Lan]["paint"].matte..")", ["item"] = Loc[Config.Lan]["paint"].wheel.." - "..AJFW.Shared.Items["paintcan"].label } end end
		for k, v in pairs(Loc[Config.Lan].vehicleResprayOptionsMetals) do if newproperties["wheelColor"] == v.id then
		vehlist[#vehlist+1] = Loc[Config.Lan]["paint"].wheel.."Color - [ "..v.name.." ("..Loc[Config.Lan]["paint"].metals..") ]" modlist[#modlist+1] = {['type'] = v.name.." ("..Loc[Config.Lan]["paint"].metals..")", ["item"] = Loc[Config.Lan]["paint"].wheel.." - "..AJFW.Shared.Items["paintcan"].label } end end
		for k, v in pairs(Loc[Config.Lan].vehicleResprayOptionsChameleon) do if newproperties["wheelColor"] == v.id then
		vehlist[#vehlist+1] = Loc[Config.Lan]["paint"].wheel.."Color - [ "..v.name.." ("..Loc[Config.Lan]["paint"].chameleon..") ]" modlist[#modlist+1] = {['type'] = v.name.." ("..Loc[Config.Lan]["paint"].chameleon..")", ["item"] = Loc[Config.Lan]["paint"].wheel.." - "..AJFW.Shared.Items["paintcan"].label } end end
		end
	if properties["dashboardColor"] ~= newproperties["dashboardColor"] then
		...
		vehlist[#vehlist+1] = Loc[Config.Lan]["paint"].dashboard.."Color - [ "..v.name.." ("..Loc[Config.Lan]["paint"].metallic..") ]" modlist[#modlist+1] = {['type'] = v.name.." ("..Loc[Config.Lan]["paint"].metallic..")", ["item"] = Loc[Config.Lan]["paint"].dashboard.." - "..AJFW.Shared.Items["paintcan"].label } end end
		for k, v in pairs(Loc[Config.Lan].vehicleResprayOptionsMatte) do if newproperties["dashboardColor"] == v.id then
		vehlist[#vehlist+1] = Loc[Config.Lan]["paint"].dashboard.."Color - [ "..v.name.." ("..Loc[Config.Lan]["paint"].matte..") ]" modlist[#modlist+1] = {['type'] = v.name.." ("..Loc[Config.Lan]["paint"].matte..")", ["item"] = Loc[Config.Lan]["paint"].dashboard.." - "..AJFW.Shared.Items["paintcan"].label } end end
		for k, v in pairs(Loc[Config.Lan].vehicleResprayOptionsMetals) do if newproperties["dashboardColor"] == v.id then
		vehlist[#vehlist+1] = Loc[Config.Lan]["paint"].dashboard.."Color - [ "..v.name.." ("..Loc[Config.Lan]["paint"].metals..") ]" modlist[#modlist+1] = {['type'] = v.name.." ("..Loc[Config.Lan]["paint"].metals..")", ["item"] = Loc[Config.Lan]["paint"].dashboard.." - "..AJFW.Shared.Items["paintcan"].label } end end
	end
	if properties["interiorColor"] ~= newproperties["interiorColor"] then
		...
		vehlist[#vehlist+1] = Loc[Config.Lan]["paint"].interior.." - [ "..v.name.." ("..Loc[Config.Lan]["paint"].metallic..") ]" modlist[#modlist+1] = {['type'] = v.name.." ("..Loc[Config.Lan]["paint"].metallic..")", ["item"] = Loc[Config.Lan]["paint"].interior.." - "..AJFW.Shared.Items["paintcan"].label } end end
		for k, v in pairs(Loc[Config.Lan].vehicleResprayOptionsMatte) do if newproperties["interiorColor"] == v.id then
		vehlist[#vehlist+1] = Loc[Config.Lan]["paint"].interior.." - [ "..v.name.." ("..Loc[Config.Lan]["paint"].matte..") ]" modlist[#modlist+1] = {['type'] = v.name.." ("..Loc[Config.Lan]["paint"].matte..")", ["item"] = Loc[Config.Lan]["paint"].interior.." - "..AJFW.Shared.Items["paintcan"].label } end end
		for k, v in pairs(Loc[Config.Lan].vehicleResprayOptionsMetals) do if newproperties["interiorColor"] == v.id then
		vehlist[#vehlist+1] = Loc[Config.Lan]["paint"].interior.." - [ "..v.name.." ("..Loc[Config.Lan]["paint"].metals..") ]" modlist[#modlist+1] = {['type'] = v.name.." ("..Loc[Config.Lan]["paint"].metals..")", ["item"] = Loc[Config.Lan]["paint"].interior.." - "..AJFW.Shared.Items["paintcan"].label } end end
	end
	if properties["modFrontWheels"] ~= newproperties["modFrontWheels"] then
		...
		if GetLabelText(GetModTextLabel(vehicle, 23, (newproperties["modFrontWheels"]))) == "NULL" then
			...
			modlist[#modlist+1] = {['type'] = "("..name..")", ["item"] = "Wheels - [ "..GetLabelText(GetModTextLabel(vehicle, 23, (newproperties["modFrontWheels"]))).." ("..newproperties["modFrontWheels"]..") - "..AJFW.Shared.Items["rims"].label }
		else
			vehlist[#vehlist+1] = "Wheels - [ "..GetLabelText(GetModTextLabel(vehicle, 23, (newproperties["modFrontWheels"]))).." ("..name..") ]"
			modlist[#modlist+1] = {['type'] = "("..name..")", ["item"] = "Wheels - [ "..GetLabelText(GetModTextLabel(vehicle, 23, (newproperties["modFrontWheels"]))).." ] - "..AJFW.Shared.Items["rims"].label }
		end
	...
	if properties["modBackWheels"] ~= newproperties["modBackWheels"] then
		...
		if GetLabelText(GetModTextLabel(vehicle, 23, (newproperties["modFrontWheels"]))) == "NULL" then
			...
			modlist[#modlist+1] = {['type'] = "("..name..")", ["item"] = "Back Wheels - [ "..GetLabelText(GetModTextLabel(vehicle, 24, (newproperties["modBackWheels"]))).." ("..newproperties["modBackWheels"]..") - "..AJFW.Shared.Items["rims"].label }
		else
			vehlist[#vehlist+1] = "Back Wheels - [ "..GetLabelText(GetModTextLabel(vehicle, 24, (newproperties["modBackWheels"]))).." ("..name..") ]"
			modlist[#modlist+1] = {['type'] = "("..name..")", ["item"] = "Back Wheels - [ "..GetLabelText(GetModTextLabel(vehicle, 24, (newproperties["modBackWheels"]))).." ] - "..AJFW.Shared.Items["rims"].label  }
		end
		SetVehicleWheelType(vehicle, originalWheel)
	end
	if properties["plateIndex"] ~= newproperties["plateIndex"] then
		for k, v in pairs(Loc[Config.Lan].vehiclePlateOptions) do
			if newproperties["plateIndex"] == v.id then
				...
				modlist[#modlist+1] = {['type'] = "("..v.name..")", ["item"] = Loc[Config.Lan]["police"].plates.." - "..AJFW.Shared.Items["customplate"].label }
			end
		end
	end
	if properties["windowTint"] ~= newproperties["windowTint"] then
		...
		modlist[#modlist+1] = {['type'] = "("..name..")", ["item"] = Loc[Config.Lan]["windows"].menuheader.." - "..AJFW.Shared.Items["tint_supplies"].label }
	end
	if properties["modSpoilers"] ~= newproperties["modSpoilers"] then
		...
		modlist[#modlist+1] = {['type'] = "("..GetLabelText(GetModTextLabel(vehicle, 0, (newproperties["modSpoilers"])))..")", ["item"] = Loc[Config.Lan]["check"].label15..tostring(newproperties["modSpoilers"]+1 .." ] - "..AJFW.Shared.Items["spoiler"].label)}
	end
	if properties["modFrontBumper"] ~= newproperties["modFrontBumper"] then
		...
		modlist[#modlist+1] = {['type'] = "("..GetLabelText(GetModTextLabel(vehicle, 1, (newproperties["modFrontBumper"])))..")", ["item"] = Loc[Config.Lan]["check"].label16..tostring(newproperties["modFrontBumper"]+1 .." ] - "..AJFW.Shared.Items["bumper"].label)}
	end
	if properties["modRearBumper"] ~= newproperties["modRearBumper"] then
		...
		modlist[#modlist+1] = {['type'] = "("..GetLabelText(GetModTextLabel(vehicle, 2, (newproperties["modRearBumper"])))..")", ["item"] = Loc[Config.Lan]["check"].label17..tostring(newproperties["modRearBumper"]+1 .." ] - "..AJFW.Shared.Items["bumper"].label)}
	end
	if properties["modSideSkirt"] ~= newproperties["modSideSkirt"] then
		...
		modlist[#modlist+1] = {['type'] = "("..GetLabelText(GetModTextLabel(vehicle, 3, (newproperties["modSideSkirt"])))..")", ["item"] = Loc[Config.Lan]["check"].label18..tostring(newproperties["modSideSkirt"]+1 .." ] - "..AJFW.Shared.Items["skirts"].label)}
	end
	if properties["modExhaust"] ~= newproperties["modExhaust"] then
		...
		modlist[#modlist+1] = {['type'] = "("..GetLabelText(GetModTextLabel(vehicle, 4, (newproperties["modExhaust"])))..")", ["item"] = Loc[Config.Lan]["check"].label19..tostring(newproperties["modExhaust"]+1 .." ] - "..AJFW.Shared.Items["spoiler"].label)}
	end
	if properties["modGrille"] ~= newproperties["modGrille"] then
		...
		modlist[#modlist+1] = {['type'] = "("..GetLabelText(GetModTextLabel(vehicle, 6, (newproperties["modGrille"])))..")", ["item"] = Loc[Config.Lan]["check"].label20..tostring(newproperties["modGrille"]+1 .." ] - "..AJFW.Shared.Items["exhaust"].label)}
	end
	if properties["modHood"] ~= newproperties["modHood"] then
		...
		modlist[#modlist+1] = {['type'] = "("..GetLabelText(GetModTextLabel(vehicle, 7, (newproperties["modHood"])))..")", ["item"] = Loc[Config.Lan]["check"].label21..tostring(newproperties["modHood"]+1 .." ] - "..AJFW.Shared.Items["hood"].label)}
	end
	if properties["modFender"] ~= newproperties["modFender"] then
		...
		modlist[#modlist+1] = {['type'] = "("..GetLabelText(GetModTextLabel(vehicle, 8, (newproperties["modFender"])))..")", ["item"] = Loc[Config.Lan]["check"].label22..tostring(newproperties["modFender"]+1 .." ] - "..AJFW.Shared.Items["skirts"].label)}
	end
	if properties["modRightFender"] ~= newproperties["modRightFender"] then
		...
		modlist[#modlist+1] = {['type'] = "("..GetLabelText(GetModTextLabel(vehicle, 9, (newproperties["modRightFender"])))..")", ["item"] = Loc[Config.Lan]["check"].label23..tostring(newproperties["modRightFender"]+1 .." ] - "..AJFW.Shared.Items["skirts"].label)}
	end
	if properties["modRoof"] ~= newproperties["modRoof"] then
		...
		modlist[#modlist+1] = {['type'] = "("..GetLabelText(GetModTextLabel(vehicle, 10, (newproperties["modRoof"])))..")", ["item"] = Loc[Config.Lan]["check"].label24..tostring(newproperties["modRoof"]+1 .." ] - "..AJFW.Shared.Items["roof"].label)}
	end
	if properties["modPlateHolder"] ~= newproperties["modPlateHolder"] then
		...
		modlist[#modlist+1] = {['type'] = "("..GetLabelText(GetModTextLabel(vehicle, 25, (newproperties["modPlateHolder"])))..")", ["item"] = Loc[Config.Lan]["check"].label25..tostring(newproperties["modPlateHolder"]+1 .." ] - "..AJFW.Shared.Items["customplate"].label)}
	end
	if properties["modVanityPlate"] ~= newproperties["modVanityPlate"] then
		...
		modlist[#modlist+1] = {['type'] = "("..GetLabelText(GetModTextLabel(vehicle, 26, (newproperties["modVanityPlate"])))..")", ["item"] = Loc[Config.Lan]["check"].label26..tostring(newproperties["modVanityPlate"]+1 .." ] - "..AJFW.Shared.Items["customplate"].label)}
	end
	if properties["modTrimA"] ~= newproperties["modTrimA"] then
		...
		modlist[#modlist+1] = {['type'] = "("..GetLabelText(GetModTextLabel(vehicle, 27, (newproperties["modTrimA"])))..")", ["item"] = Loc[Config.Lan]["check"].label27..tostring(newproperties["modTrimA"]+1 .." ] - "..AJFW.Shared.Items["externals"].label)}
	end
	if properties["modTrimB"] ~= newproperties["modTrimB"] then
		...
		modlist[#modlist+1] = {['type'] = "("..GetLabelText(GetModTextLabel(vehicle, 44, (newproperties["modTrimB"])))..")", ["item"] = Loc[Config.Lan]["check"].label28..tostring(newproperties["modTrimB"]+1 .." ] - "..AJFW.Shared.Items["externals"].label)}
	end
	if properties["modTrunk"] ~= newproperties["modTrunk"] then
		...
		modlist[#modlist+1] = {['type'] = "("..GetLabelText(GetModTextLabel(vehicle, 37, (newproperties["modTrunk"])))..")", ["item"] = Loc[Config.Lan]["check"].label29..tostring(newproperties["modTrunk"]+1 .." ] - "..AJFW.Shared.Items["externals"].label)}
	end
	if properties["modEngineBlock"] ~= newproperties["modEngineBlock"] then
		...
		modlist[#modlist+1] = {['type'] = "("..GetLabelText(GetModTextLabel(vehicle, 39, (newproperties["modEngineBlock"])))..")", ["item"] = Loc[Config.Lan]["check"].label30..tostring(newproperties["modEngineBlock"]+1 .." ] - "..AJFW.Shared.Items["externals"].label)}
	end
	if properties["modAirFilter"] ~= newproperties["modAirFilter"] then
		...
		modlist[#modlist+1] = {['type'] = "("..GetLabelText(GetModTextLabel(vehicle, 40, (newproperties["modAirFilter"])))..")", ["item"] = Loc[Config.Lan]["check"].label31..tostring(newproperties["modAirFilter"]+1 .." ] - "..AJFW.Shared.Items["externals"].label)}
	end
	if properties["modStruts"] ~= newproperties["modStruts"] then
		...
		modlist[#modlist+1] = {['type'] = "("..GetLabelText(GetModTextLabel(vehicle, 41, (newproperties["modStruts"])))..")", ["item"] = Loc[Config.Lan]["check"].label32..tostring(newproperties["modStruts"]+1 .." ] - "..AJFW.Shared.Items["externals"].label)}
	end
	if properties["modArchCover"] ~= newproperties["modArchCover"] then
		...
		modlist[#modlist+1] = {['type'] = "("..GetLabelText(GetModTextLabel(vehicle, 42, (newproperties["modArchCover"])))..")", ["item"] = Loc[Config.Lan]["check"].label33..tostring(newproperties["modArchCover"]+1 .." ] - "..AJFW.Shared.Items["externals"].label)}
	end
	...
	if properties["modFrame"] ~= newproperties["modFrame"] then
		...
		modlist[#modlist+1] = {['type'] = "("..GetLabelText(GetModTextLabel(vehicle, 5, (newproperties["modFrame"])))..")", ["item"] = Loc[Config.Lan]["check"].label34..tostring(newproperties["modFrame"]+1 .." ] - "..AJFW.Shared.Items["rollcage"].label)}
	end
	if properties["modOrnaments"] ~= newproperties["modOrnaments"] then
		...
		modlist[#modlist+1] = {['type'] = "("..GetLabelText(GetModTextLabel(vehicle, 5, (newproperties["modOrnaments"])))..")", ["item"] = Loc[Config.Lan]["check"].label35..tostring(newproperties["modOrnaments"]+1 .." ] - "..AJFW.Shared.Items["internals"].label)}
	end
	if properties["modDashboard"] ~= newproperties["modDashboard"] then
		...
		modlist[#modlist+1] = {['type'] = "("..GetLabelText(GetModTextLabel(vehicle, 29, (newproperties["modDashboard"])))..")", ["item"] = Loc[Config.Lan]["check"].label36..tostring(newproperties["modDashboard"]+1 .." ] - "..AJFW.Shared.Items["internals"].label)}
	end
	if properties["modDial"] ~= newproperties["modDial"] then
		...
		modlist[#modlist+1] = {['type'] = "("..GetLabelText(GetModTextLabel(vehicle, 30, (newproperties["modDial"])))..")", ["item"] = Loc[Config.Lan]["check"].label37..tostring(newproperties["modDial"]+1 .." ] - "..AJFW.Shared.Items["internals"].label)}
	end
	if properties["modDoorSpeaker"] ~= newproperties["modDoorSpeaker"] then
		...
		modlist[#modlist+1] = {['type'] = "("..GetLabelText(GetModTextLabel(vehicle, 31, (newproperties["modDoorSpeaker"])))..")", ["item"] = Loc[Config.Lan]["check"].label38..tostring(newproperties["modDoorSpeaker"]+1 .." ] - "..AJFW.Shared.Items["internals"].label)}
	end
	if properties["modSeats"] ~= newproperties["modSeats"] then
		...
		modlist[#modlist+1] = {['type'] = "("..GetLabelText(GetModTextLabel(vehicle, 32, (newproperties["modSeats"])))..")", ["item"] = Loc[Config.Lan]["check"].label39..tostring(newproperties["modSeats"]+1 .." ] - "..AJFW.Shared.Items["seat"].label)}
	end
	if properties["modSteeringWheel"] ~= newproperties["modSteeringWheel"] then
		...
		modlist[#modlist+1] = {['type'] = "("..GetLabelText(GetModTextLabel(vehicle, 33, (newproperties["modSteeringWheel"])))..")", ["item"] = Loc[Config.Lan]["check"].label40..tostring(newproperties["modSteeringWheel"]+1 .." ] - "..AJFW.Shared.Items["internals"].label)}
	end
	if properties["modShifterLeavers"] ~= newproperties["modShifterLeavers"] then
		...
		modlist[#modlist+1] = {['type'] = "("..GetLabelText(GetModTextLabel(vehicle, 34, (newproperties["modShifterLeavers"])))..")", ["item"] = Loc[Config.Lan]["check"].label41..tostring(newproperties["modShifterLeavers"]+1 .." ] - "..AJFW.Shared.Items["internals"].label)}
	end
	if properties["modAPlate"] ~= newproperties["modAPlate"] then
		...
		modlist[#modlist+1] = {['type'] = "("..GetLabelText(GetModTextLabel(vehicle, 35, (newproperties["modAPlate"])))..")", ["item"] = Loc[Config.Lan]["check"].label42..tostring(newproperties["modAPlate"]+1 .." ] - "..AJFW.Shared.Items["internals"].label)}
	end
	if properties["modSpeakers"] ~= newproperties["modSpeakers"] then
		...
		modlist[#modlist+1] = {['type'] = "("..GetLabelText(GetModTextLabel(vehicle, 36, (newproperties["modAPlate"])))..")", ["item"] = Loc[Config.Lan]["check"].label43..tostring(newproperties["modAPlate"]+1 .." ] - "..AJFW.Shared.Items["internals"].label)}
	end
	if properties["modHydrolic"] ~= newproperties["modHydrolic"] then
		...
		modlist[#modlist+1] = {['type'] = "("..GetLabelText(GetModTextLabel(vehicle, 38, (newproperties["modHydrolic"])))..")", ["item"] = Loc[Config.Lan]["check"].label44..tostring(newproperties["modHydrolic"]+1 .." ] - "..AJFW.Shared.Items["externals"].label)}
	end
	if properties["modAerials"] ~= newproperties["modAerials"] then
		...
		modlist[#modlist+1] = {['type'] = "("..GetLabelText(GetModTextLabel(vehicle, 43, (newproperties["modAerials"])))..")", ["item"] = Loc[Config.Lan]["check"].label45..tostring(newproperties["modAerials"]+1 .." ] - "..AJFW.Shared.Items["externals"].label)}
	end
	if properties["modTank"] ~= newproperties["modTank"] then
		...
		modlist[#modlist+1] = {['type'] = "("..GetLabelText(GetModTextLabel(vehicle, 45, (newproperties["modTank"])))..")", ["item"] = Loc[Config.Lan]["check"].label46..tostring(newproperties["modTank"]+1 .." ] - "..AJFW.Shared.Items["externals"].label)}
	end
	if properties["modLivery"] ~= newproperties["modLivery"] then
		...
		modlist[#modlist+1] = {['type'] = "("..GetLabelText(GetModTextLabel(vehicle, 48, (newproperties["modLivery"])))..")", ["item"] = Loc[Config.Lan]["police"].livery.." - [ "..tostring(newproperties["modLivery"]+1 .." ] - "..AJFW.Shared.Items["livery"].label)}
	end
	...
	if Config.PreviewPhone then
		if vehlist[1] then
			...
			elseif Config.PhoneMail == "aj" then event = 'aj-phone:server:sendNewMail' end
...
local function preview(playerPed, vehicle)
	...
	properties = AJFW.Functions.GetVehicleProperties(vehicle)

...
- This script requires `aj-target` for opening stores, crafting tables, cash registers, going on duty, nos refill
...
local function DamageRandomComponent()
    ...
    exports['qb-mechanicjob']:SetVehicleStatus(AJFW.Functions.GetPlate(vehicle), randomComponent, exports['qb-mechanicjob']:GetVehicleStatus(AJFW.Functions.GetPlate(vehicle), randomComponent) - randomDamage)
end
```
...
## 2.9.3:
    ...
    - Server Side + Client Side AJFW HasItem functions are now built into the script
...
## 2.9.2:
    ...
    - Overhauled the Neon/Xenon colours menus
        ...
        - This also **REQUIRES** you to replace the AJFW.Functions from the install.md

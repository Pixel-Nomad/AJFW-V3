...
function toggleItem(give, item, amount) TriggerServerEvent("aj-mining:server:toggleItem", give, item, amount) end
...
function progressBar(data)
	...
	if Config.ProgressBar == "ox" then
		...
		AJFW.Functions.Progressbar("mechbar",	data.label,	Config.Debug and 1000 or data.time, data.dead, data.cancel or true,

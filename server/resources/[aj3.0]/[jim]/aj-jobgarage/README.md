...
- I always recommend starting my scripts **AFTER** `[aj]` not inside it as it can mess with any dependancies on server load
...
```lua
TriggerEvent("aj-jobgarage:server:syncAddLocations", {
job = "mechanic",
garage = {

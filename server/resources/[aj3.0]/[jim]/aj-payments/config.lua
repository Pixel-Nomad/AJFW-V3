print("^2aj^7-^2Payments ^7v^42^7.^48^7.^45 ^7- ^2Payments Script by ^1aj^7")
...
Config = {
	Lan = "en",
	Debug = false,
	Notify = "aj",		-- "aj" | "okok" | "t" | "infinity" | "rr"
	Menu = "ox",
	...
	PhoneType = "aj", -- Change this setting to make invoices work with your phone script [still testing this currently]
						-- "aj" for aj-phone
						-- "gks"" for GKSPhone
	...
	---Target doesn't seem to like ALL ATM Props so need to manually add locations
	WallATMLocations = {

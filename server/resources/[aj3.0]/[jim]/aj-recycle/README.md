# aj-recycle
FiveM Custom AJFW recycling script made by me from scratch
...
- Customisable points for Selling materials
  - Add a Location for an ore to the config and it will use this location for both aj-target and a prop
...
- add the following code to your server.cfg/resources.cfg **below** `[aj]`
```
ensure aj-recycle
```
### Item installation
...
- Add the images to your inventory folder
  - for example: `[aj] > aj-inventory > html > images`
- **This script supports automatic installation of items to items.lua with newer AJFW exports**

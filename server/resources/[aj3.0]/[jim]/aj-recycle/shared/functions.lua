Core = exports['aj-base']:GetCoreObject()

--Core = {}
if Config.Core == "aj" then
	local CoreConvert = exports['aj-base']:GetCoreObject()
...
function toggleItem(give, item, amount) TriggerServerEvent("aj-recycle:server:toggleItem", give, item, amount) end

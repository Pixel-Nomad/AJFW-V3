<script lang="ts">
  ...
  function handleIsToggleSpeedChecked(checked: boolean) {
    let shape: "mph" | "kmh" = checked ? "mph": "kmh";
...
<div class="text-sm flex flex-col text-[#e8e8e8]">
  <div class="mx-4 mb-5 mt-3">
    ...
    <Button name="Reset Hud" buttonClass="whitespace-nowrap hover:bg-[#ff005e]" disable={$MenuStore.isRestarting} disableText={"Resetting Hud..."}
    ...
    <Button name="Reset Settings" buttonClass="hover:bg-[#ff005e]"
      on:click={() => {
  ...
  <div class="mx-4 mb-4 flex flex-col">
    ...
    <Switch checked={$MenuStore.isToggleSpeedChecked == "mph"} checkedText="Speed In MPH" unCheckedText="Speed In KMH"
      handleUpdateFunction={(checked) => handleIsToggleSpeedChecked(checked)}
    />
    <p class="font-semibold text-base pb-2">

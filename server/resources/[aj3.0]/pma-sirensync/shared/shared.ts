...
export const AddonAudioBanks: Map<string, { bankName: string, sounds: string | string[] }> = new Map<string, { bankName: string, sounds: string | string[] }>()
    .set("DLC_WMSIRENS_SOUNDSET", { bankName: "DLC_WMSIRENS\\SIRENPACK_ONE", sounds: ["SIREN_ALPHA", "SIREN_BRAVO", "SIREN_CHARLIE", "SIREN_DELTA", "SIREN_ECHO", "SIREN_FOXTROT", "SIREN_GOLF", "SIREN_HOTEL"] })

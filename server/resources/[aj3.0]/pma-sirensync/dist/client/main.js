    ...
    switch (soundMode) {
      case 1: {
        if (Rumbeler == 1) {
          ...
          PlaySoundFromEntity(soundId, "SIREN_ALPHA", ent, "DLC_WMSIRENS2_SOUNDSET", false, 0);
        } else if (Rumbeler == 0) {
      ...
      case 2: {
        if (Rumbeler == 1) {
          ...
          PlaySoundFromEntity(soundId, "SIREN_BRAVO", ent, "DLC_WMSIRENS2_SOUNDSET", false, 0);
        } else if (Rumbeler == 0) {
      ...
      case 3: {
        if (Rumbeler == 1) {
          ...
          PlaySoundFromEntity(soundId, "SIREN_CHARLIE", ent, "DLC_WMSIRENS2_SOUNDSET", false, 0);
        } else if (Rumbeler == 0) {

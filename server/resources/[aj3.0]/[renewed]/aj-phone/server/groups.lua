...
lib.callback.register('aj-phone:server:GetGroupsApp', function(_)
...
lib.callback.register('aj-phone:server:getAllGroups', function(source)
    local src = source
...
lib.callback.register('aj-phone:server:jobcenter_CheckPlayerNames', function(_, csn)
    local Names = {}

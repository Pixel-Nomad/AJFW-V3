...
RegisterNetEvent('aj-phone:server:Send_lsbn_ToChat', function(data)
    ...
    TriggerClientEvent('aj-phone:LSBN-reafy-for-add', -1, Tables, true, data.Text)
end)

RegisterNetEvent('aj-phone:server:GetLSBNchats', function()
    local src = source
    TriggerClientEvent('aj-phone:LSBN-reafy-for-add', src, LSBNTable, false, nil)
end)
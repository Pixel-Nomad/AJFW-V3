...
local function show_transport_menu()
     ...
     local openMenu = {
          ...
          },
          {
               ...
               txt = "",
               params = {
                    event = 'aj-oilwell:menu:show_transport_menu:ask_stock_price',
               }
          },
          {
               ...
               txt = "",
               params = {
                    event = 'aj-oilwell:menu:show_transport_menu:ask_to_sell_amount',
               }
          },
          {
               header = 'leave',
...
AddEventHandler('aj-oilwell:menu:show_transport_menu', function()
     show_transport_menu()
end)

AddEventHandler('aj-oilwell:menu:show_transport_menu:ask_stock_price', function()
     TriggerServerEvent('aj-oilrig:server:oil_transport:checkPrice')
end)
...
AddEventHandler('aj-oilwell:menu:show_transport_menu:ask_to_sell_amount', function()
     ...
     if inputData then
          ...
          AJFW.Functions.Progressbar("aj_oilwell_transport", 'Filling', Oilwell_config.Transport.duration * 1000,
               false, false, {
               ...
               AJFW.Functions.TriggerCallback('aj-oilrig:server:oil_transport:fillTransportWell', function(res)
...
local function isBarellInInventory()
     local items = AJFW.Functions.GetPlayerData().items

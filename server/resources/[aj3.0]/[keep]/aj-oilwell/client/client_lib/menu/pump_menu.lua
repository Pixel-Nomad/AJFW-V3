...
local function showInfo(data)
     AJFW.Functions.TriggerCallback('aj-oilwell:server:oilwell_metadata', function(selected_oilrig)
          ...
          local openMenu = {
               ...
               },
               {
                    ...
                    params = {
                         event = 'aj-oilrig:storage_menu:PumpOilToStorage',
                         args = {
               ...
               },
               {
                    ...
                    params = {
                         event = 'aj-oilwell:menu:ManageEmployees',
...
RegisterNetEvent('aj-oilwell:menu:ManageEmployees', function(oilrig_hash)
     AJFW.Functions.TriggerCallback('aj-oilwell:server:employees_list', function(result)
          ...
          Menu[#Menu + 1] = {
               ...
               params = {
                    event = "aj-oilwell:client:add_employee",
                    args = {
          ...
          for index, employee in ipairs(result) do
               ...
               Menu[#Menu + 1] = {
                    ...
                    params = {
                         event = "aj-oilwell:menu:remove_employee",
                         args = {
                              employee = employee,
                              oilrig_hash = oilrig_hash
                         }
...
RegisterNetEvent('aj-oilwell:client:add_employee', function(data)
     ...
     if inputData then
          ...
          TriggerServerEvent('aj-oilwell:server:add_employee', data.oilrig_hash, inputData.stateId)
     end
end)

RegisterNetEvent('aj-oilwell:menu:remove_employee', function(data)
     ...
     local Menu = {
          ...
          },
          {
               ...
               params = {
                    event = "aj-oilwell:menu:fire_employee",
                    args = {
...
RegisterNetEvent('aj-oilwell:menu:fire_employee', function(data)
     TriggerServerEvent('aj-oilwell:server:remove_employee', data.oilrig_hash, data.employee.citizenid)
end)
     ...
     AJFW.Functions.TriggerCallback('aj-oilwell:server:oilwell_metadata', function(selected_oilrig)
          ...
          local openMenu = {
               ...
               },
               {
                    ...
                    params = {
                         event = 'aj-oilwell:client:openOilPump',
                         args = {
                              oilrig_hash = data.oilrig_hash
                         }
                    }
               },
               {
                    ...
                    params = {
                         event = 'aj-oilwell:client:fix_oilwell',
                         args = {
                              oilrig_hash = data.oilrig_hash
                         }
                    }
...
-- Events
AddEventHandler('aj-oilrig:storage_menu:PumpOilToStorage', function(data)
     AJFW.Functions.TriggerCallback('aj-oilrig:server:PumpOilToStorageCallback', function(result)

     end, data.oilrig_hash)
end)

AddEventHandler('aj-oilrig:client:viewPumpInfo', function(ajtarget)
     -- ask for updated data
     OilRigs:startUpdate(function()
          showInfo(OilRigs:getByEntityHandle(ajtarget.entity))
     end)
end)


AddEventHandler('aj-oilrig:client:show_oilwell_stash', function(ajtarget)
     -- ask for updated data
     OilRigs:startUpdate(function()
          show_oilwell_stash(OilRigs:getByEntityHandle(ajtarget.entity))
     end)
end)

-- Open oil pump stash.
RegisterNetEvent("aj-oilwell:client:openOilPump", function(data)
...
AddEventHandler('aj-oilwell:client:fix_oilwell', function(data)
     -- ask for updated data
     AJFW.Functions.TriggerCallback('aj-oilwell:server:fix_oil_well', function(result)
          print(result)
     end, data.oilrig_hash)

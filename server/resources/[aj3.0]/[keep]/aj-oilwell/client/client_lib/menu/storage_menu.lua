     ...
     local openMenu = {
          {
               ...
               params = {
                    event = 'aj-oilrig:storage_menu:StorageActions',
                    args = {
                         type = 'crudeOil',
     ...
     local openMenu = {
          {
               ...
               txt = "",
               params = {
                    event = 'aj-oilrig:storage_menu:StorageWithdraw',
                    args = data
               }
          },
          {
...
local function showStorageWithdraw(data)
     ...
     local openMenu = {
          ...
          },
          {
               ...
               params = {
                    event = 'aj-oilrig:storage_menu:Callback',
                    args = {
                         eventName = 'aj-oilrig:server:Withdraw',
...
MakeVehicle = function(model, Coord, TriggerLocation, DinstanceToTrigger, items)
     ...
     Targets.aj_target.truck(vehiclePlate, veh)

     TriggerServerEvent('aj-oilwell:server_lib:update_vehicle', vehiclePlate, items)
end


RegisterNetEvent('aj-oilrig:client_lib:withdraw_from_queue', function(data)
     AJFW.Functions.TriggerCallback('aj-oilrig:server:withdraw_from_queue', function(result)
          -- res >> table of items
...
AddEventHandler('aj-oilrig:storage_menu:ShowStorage', function(data)
     AJFW.Functions.TriggerCallback('aj-oilrig:server:getStorageData', function(result)
          showStorage(result)
     end)
end)

AddEventHandler('aj-oilrig:storage_menu:StorageActions', function(storage_data)
     showStorageActions(storage_data)
end)

AddEventHandler('aj-oilrig:storage_menu:StorageWithdraw', function(data)
     showStorageWithdraw(data)
end)

AddEventHandler('aj-oilrig:storage_menu:Callback', function(data)
     ...
     if inputData then
          ...
          AJFW.Functions.TriggerCallback(data.eventName, function(res)
...
-- withdraw spot
AddEventHandler("aj-oilwell:client:openWithdrawStash", function(data)
...
local function purge_menu()
     local openMenu = {
          ...
          },
          {
               ...
               params = {
                    event = 'aj-oilwell:client:purgeWithdrawStash',
               }
          },
          {
               header = 'Cancel',
...
AddEventHandler('aj-oilwell:client:open_purge_menu', function()
     purge_menu()
end)

local purge_conf = 0
AddEventHandler('aj-oilwell:client:purgeWithdrawStash', function()
     if purge_conf == 0 then
          AJFW.Functions.Notify('Try again to confirm Purge! (confirmation will reset in 5sec)', "primary")
     ...
     purge_conf = 0
     TriggerServerEvent('aj-oilwell:server:purgeWithdrawStash')
end)

...
function GetNos()
	local p = promise.new()
	AJFW.Functions.TriggerCallback('jim-mechanic:GetNosLoaded', function(vehs) p:resolve(vehs) end)
...
function GetNosColour()
	local p = promise.new()
	AJFW.Functions.TriggerCallback('jim-mechanic:GetNosColour', function(vehs) p:resolve(vehs) end)

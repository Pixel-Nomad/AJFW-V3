...
RegisterNetEvent('jim-mechanic:client:Police:Extra', function()
	...
	if hadMod then exports['aj-menu']:openMenu(ExtraMenu) elseif not hadMod then triggerNotify(nil, Loc[Config.Lan]["common"].noOptions, "error") TriggerEvent('jim-mechanic:client:Police:Menu') return end
end)

...
Config.TargetResource = "aj-target" -- Supported: { 'aj-target', 'ox_target'} -- Others must use the same format as aj-Target or manual configuration is required.
...
Config.SyphonDispatchSystem = "aj-dispatch" -- Options: "aj-dispatch", "aj-dispatch", "aj-default" (just blips) or "custom" (Custom: you must configure yourself!)
...
RegisterNetEvent('update:fuel:mode', function(mode)
	if mode == 'normal' then
		Config.FuelUsage = {
			[1.0] = 1.3,
			[0.9] = 1.1,
...
Config.GasStations = { -- Configuration options for various gas station related things, including peds, coords and labels.
    ...
    [29] = {
        ...
        cost = 10000000, -- This is the cost of the gas station for someone purchasing it, not including tax.

local function CustomAlert(data)
    ...
    TriggerServerEvent('aj-dispatch:server:notify', dispatchData)
end
...
RegisterNetEvent("aj-dispatch:client:officerdown", function() OfficerDown() end)
...
RegisterNetEvent("aj-dispatch:client:officerbackup", function() OfficerBackup() end)
...
RegisterNetEvent("aj-dispatch:client:emsdown", function() EmsDown() end)
...
RegisterNetEvent('aj-dispatch:client:sendEmergencyMsg', function(data, type, anonymous)

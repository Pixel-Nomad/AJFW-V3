...
RegisterNetEvent("aj-clothMenu:client:migration:load-aj-clothing-skin", function(playerSkin)
    ...
    Citizen.CreateThread(function()
        ...
        TriggerEvent("aj-clothMenu:client:migration:load-aj-clothing-clothes", playerSkin, cache.ped)
        SetModelAsNoLongerNeeded(model)
    end)
end)

RegisterNetEvent("aj-clothMenu:client:migration:load-aj-clothing-clothes", function(playerSkin, ped)
    ...
    TriggerServerEvent("aj-clothMenu:server:migrate-aj-clothing-skin", playerSkin.citizenid, appearance)
end)

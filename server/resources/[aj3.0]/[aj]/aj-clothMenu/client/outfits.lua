...
RegisterNetEvent("aj-clothMenu:client:loadJobOutfit", LoadJobOutfit)

RegisterNetEvent("aj-clothMenu:client:openOutfitMenu", function()
    OpenMenu(nil, "outfit")
end)

RegisterNetEvent("aj-clothMenu:client:outfitsCommand", function(isJob)
    local outfits = GetPlayerJobOutfits(isJob)
    TriggerEvent("aj-clothMenu:client:openJobOutfitsMenu", outfits)
end)

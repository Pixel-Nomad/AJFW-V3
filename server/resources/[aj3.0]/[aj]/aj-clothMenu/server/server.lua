...
lib.callback.register("aj-clothMenu:server:generateOutfitCode", function(_, outfitID)
...
lib.callback.register("aj-clothMenu:server:importOutfitCode", function(source, outfitName, outfitCode)
...
lib.callback.register("aj-clothMenu:server:getAppearance", function(source, model)
    local citizenID = Framework.GetPlayerID(source)
    return Framework.GetAppearance(citizenID, model)
end)

lib.callback.register("aj-clothMenu:server:hasMoney", function(source, shopType)
...
lib.callback.register("aj-clothMenu:server:payForTattoo", function(source, tattoo)
    local src = source
...
lib.callback.register("aj-clothMenu:server:getOutfits", function(source)
    local citizenID = Framework.GetPlayerID(source)
...
lib.callback.register("aj-clothMenu:server:getManagementOutfits", function(source, mType, gender)
...
lib.callback.register("aj-clothMenu:server:getUniform", function(source)
    return uniformCache[Framework.GetPlayerID(source)]
end)

RegisterServerEvent("aj-clothMenu:server:saveAppearance", function(appearance)
    local src = source
...
RegisterServerEvent("aj-clothMenu:server:chargeCustomer", function(shopType)
    local src = source
    local money = getMoneyForShop(shopType)
...
RegisterNetEvent("aj-clothMenu:server:saveOutfit", function(name, model, components, props)
    local src = source
    local citizenID = Framework.GetPlayerID(src)
    if outfitCache[citizenID] == nil then
        getOutfitsForPlayer(citizenID)
...
RegisterNetEvent("aj-clothMenu:server:updateOutfit", function(id, model, components, props)
    local src = source
    local citizenID = Framework.GetPlayerID(src)
    if outfitCache[citizenID] == nil then
        getOutfitsForPlayer(citizenID)
...
RegisterNetEvent("aj-clothMenu:server:saveManagementOutfit", function(outfitData)
    local src = source
...
RegisterNetEvent("aj-clothMenu:server:deleteManagementOutfit", function(id)
    Database.ManagementOutfits.DeleteByID(id)
end)

RegisterNetEvent("aj-clothMenu:server:syncUniform", function(uniform)
    local src = source
    uniformCache[Framework.GetPlayerID(src)] = uniform
end)

RegisterNetEvent("aj-clothMenu:server:deleteOutfit", function(id)
    local src = source
    local citizenID = Framework.GetPlayerID(src)
...
RegisterNetEvent("aj-clothMenu:server:resetOutfitCache", function()
    local src = source
    local citizenID = Framework.GetPlayerID(src)
    if citizenID then
...
RegisterNetEvent("aj-clothMenu:server:ChangeRoutingBucket", function()
    local src = source
    SetPlayerRoutingBucket(src, src)
end)

RegisterNetEvent("aj-clothMenu:server:ResetRoutingBucket", function()
    local src = source

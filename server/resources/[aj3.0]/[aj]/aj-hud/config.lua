...
Config.FuelScript = 'aj-fuel' -- change to lj-fuel if you use lj-fuel or something else if you use any other LegcyFuel compatible script

Config.VehicleHud = false

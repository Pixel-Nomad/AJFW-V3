  ...
  function getDefaultSettings(): colorEffectStoreType {
    return {
      ...
      icons: {
        ...
        driveMode: getLocalStorage("driveMode", {
          currentEffect: 0,
          colorEffects: [
            defaultColorEffect("eco-mode", "#3FA554"),
            defaultColorEffect("normal-mode", "#dd6e14"),
            defaultColorEffect("sports-mode", "#ff0000"),
          ],
          editableColors: defaultEditableColor(),
        }),
        injail: getLocalStorage("injail", {
          currentEffect: 0,
          colorEffects: [
            defaultColorEffect("Prison", "#ff0000"),
          ],
          editableColors: defaultEditableColor(),
        }),
        crimeactive : getLocalStorage("crimeactive", {
          currentEffect: 0,
          colorEffects: [
            defaultColorEffect("Active Crime", "#ff0000"),
          ],
          editableColors: defaultEditableColor(),
        }),
        crimecooldown: getLocalStorage('crimecooldown', {
          currentEffect: 0,
          colorEffects: [
            defaultColorEffect("Cooldown Crime", "#0000ff"),
          ],
          editableColors: defaultEditableColor(),
        }),
        pursuitmode: getLocalStorage('pursuitmode', {
          colorEffects: [
            defaultColorEffect("A+ Mode", "#3d87ff"),
            defaultColorEffect("B+ Mode", "#ffb53d"),
            defaultColorEffect("S+ Mode", "#ff3d3d"),
          ],
          editableColors: defaultEditableColor(),
        }),
        nitroMode: getLocalStorage('nitroMode', {
          colorEffects: [
            defaultColorEffect("Level 1", "#d1a1ff"),
            defaultColorEffect("Level 2", "#b775e7"),
            defaultColorEffect("Level 3", "#9d4ad5"),
          ],
          editableColors: defaultEditableColor(),
        }),
        PurgeMode: getLocalStorage('PurgeMode', {
          colorEffects: [
            defaultColorEffect("Level 1", "#00FF00"),
            defaultColorEffect("Level 2", "#33FF00"),
            defaultColorEffect("Level 3", "#66FF00"),
            defaultColorEffect("Level 4", "#99FF00"),
            defaultColorEffect("Level 5", "#CCFF00"),
            defaultColorEffect("Level 6", "#FFCC00"),
            defaultColorEffect("Level 7", "#FF9900"),
            defaultColorEffect("Level 8", "#FF6600"),
            defaultColorEffect("Level 9", "#FF3300"),
            defaultColorEffect("Level 10", "#FF0000"),
          ],
          editableColors: defaultEditableColor(),
        }),
        waypoint : getLocalStorage("waypoint", {
          currentEffect: 0,
          colorEffects: [
            defaultColorEffect("waypoint", "#ffa200"),
          ],
          editableColors: defaultEditableColor(),
        }),
        service : getLocalStorage("service", {
          currentEffect: 0,
          colorEffects: [
            defaultColorEffect("service", "#ff0000"),
          ],
          editableColors: defaultEditableColor(),
        }),
      }

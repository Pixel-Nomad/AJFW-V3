...
export const iconNames = [
  "voice", "health", "armor", "hunger", 
  "thirst", "stress","oxygen", "armed", 
  "parachute", "engine","driveMode","pursuitmode",
  "waypoint","service", "injail", "crimeactive", 
  "crimecooldown", "harness", "cruise", "nitro", 
  "nitroMode", "PurgeMode", "dev"
] as const;
export type iconNamesKind = typeof iconNames[number];

export const dynamicOptionIconNames = [
  "armor", "engine","driveMode","pursuitmode",
  "waypoint","service", "injail", "crimeactive", 
  "crimecooldown",  "health", "hunger", "nitro", 
  "nitroMode", "PurgeMode", "oxygen", "stress", 
  "thirst"
] as const;

...
AJFW.Commands.Add('cash', 'Check Cash Balance', {}, false, function(source, args)
    local Player = AJFW.Functions.GetPlayer(source)
    local cashamount = Player.PlayerData.money.cash
    TriggerClientEvent('hud:client:ShowAccounts', source, 'cash', cashamount)
end)

AJFW.Commands.Add('bank', 'Check Bank Balance', {}, false, function(source, args)
    local Player = AJFW.Functions.GetPlayer(source)
...
AJFW.Functions.CreateCallback('hud:server:getMenu', function(source, cb)
    cb(Config.Menu)
end) 

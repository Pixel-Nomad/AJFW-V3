...
CreateThread(function()
	while true do
        Wait(0)
        if NetworkIsSessionStarted() and AJFW then
            Wait(1500)
            createPeds()
			return
		end
...
function createPeds()
    ...
    AJFW.Functions.TriggerCallback('aj-multichar:server:get', function(chars, max)
        if #chars > 0 and chars[1] then
            AJFW.Functions.TriggerCallback('aj-multichar:server:getSkin', function(data)
...
RegisterNUICallback("create", function(data, cb)
    AJFW.Functions.TriggerCallback('aj-multichar:server:createCharacter', function(res)
        cb(res)
...
RegisterNUICallback("select", function(data, cb)
    ...
    TriggerServerEvent('aj-multichar:server:spawnPlayer', data.citizenid)
end)

RegisterNUICallback("delete", function(data, cb)
    AJFW.Functions.TriggerCallback('aj-multichar:server:deleteCharacter', function(chars, max)
        DeletePed(CreatedPeds['default'])
        CreatedPeds = {}
        PlayerCharacters = {}
        currentChar = nil

...
RegisterNUICallback('PostNewTweet', function(data, cb)
    ...
    TriggerServerEvent('aj-phone:server:UpdateTweets', TweetMessage)
    cb("ok")
end)
...
RegisterNUICallback('FlagTweet',function(data, cb)
    AJFW.Functions.Notify(data.name..' was reported for saying '..data.message, "error")
    cb('ok')
end)

-- Events

RegisterNetEvent('aj-phone:client:UpdateTweets', function(src, Tweets, delete)

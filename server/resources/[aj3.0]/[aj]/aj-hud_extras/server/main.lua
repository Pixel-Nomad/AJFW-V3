...
AJFW.Functions.CreateCallback('buffs:server:fetchBuffs', function(source, cb)
    local player = AJFW.Functions.GetPlayer(source)
    local citizenID = player.PlayerData.citizenid
    cb(playerBuffs[citizenID])
end)

AJFW.Functions.CreateCallback('buffs:server:addBuff', function(source, cb, buffName, time)
    local player = AJFW.Functions.GetPlayer(source)
    local citizenID = player.PlayerData.citizenid

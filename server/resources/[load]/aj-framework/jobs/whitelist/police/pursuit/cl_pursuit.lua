...
-- 	if (IsPedInAnyVehicle(GlobalPlayerPedID, true)) then
-- 		local veh = GetVehiclePedIsIn(GlobalPlayerPedID,false)  
...
-- Modular:CreateBind('Pursuit', nil, 'Police: Pusuit Mode +', '', function()
--     local ped = GlobalPlayerPedID
...
-- Modular:CreateBind('Pursuit2', nil, 'Police: Pusuit Mode -', '', function()
--     local ped = GlobalPlayerPedID
-- 	local veh = GetVehiclePedIsIn(ped,false)
--     if IsPedSittingInAnyVehicle(ped) and IsVehicleModel(veh,defaultHash) or IsVehicleModel(veh,defaultHash2) or IsVehicleModel(veh,defaultHash3) or IsVehicleModel(veh,defaultHash4)  and PlayerData.metadata['pursuit'] then
--         if (not IsPauseMenuActive()) then 

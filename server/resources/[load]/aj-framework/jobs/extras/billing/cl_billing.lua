...
RegisterNetEvent('billing:client:sendBillingMail',function(name,price,reason,citizenid)
...
RegisterNetEvent('billing:client:AcceptBill',function(data)
...
--MAIL
RegisterNetEvent('billing:client:sendBillingMail1',function(name,reason,citizenid)
    table.insert(data,citizenid)
    TriggerServerEvent('aj-phone:server:sendNewMail', {
        sender = " "..name.."@AJ.com",
        subject = "Mail",

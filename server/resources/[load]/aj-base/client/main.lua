...
local function drawText(text, position, r, g, b, aa, types, top)
...
local function changeText(text, position, r, g, b, aa, types, top)
    if type(position) ~= 'string' then position = 'left' end
    r = r or 0
    g = g or 94
    b = b or 255
...
RegisterNetEvent('aj-base:client:DrawText', function(text, position, r, g, b, aa, types, top)
    drawText(text, position, r, g, b, aa, types, top)
end)

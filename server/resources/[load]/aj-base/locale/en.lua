local Translations = {
    error = {
        ...
        duplicate_license           = '[AJFW] - Duplicate Rockstar License Found',
        no_valid_license            = '[AJFW] - No Valid Rockstar License Found',
        not_whitelisted             = '[AJFW] - You\'re not whitelisted for this server',
        ...
        connecting_database_error   = '[AJFW] - A database error occurred while connecting to the server. (Is the SQL server on?)',
        connecting_database_timeout = '[AJFW] - Connection to database timed out. (Is the SQL server on?)',
    },
    success = {

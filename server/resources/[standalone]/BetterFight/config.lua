...
Config.Weapons= {
    ...
    --Pistol--
    [1] = { hash = `WEAPON_PISTOL`, recoil = 1.50, rightLeftRecoil = 1.00, vehicleRecoil = 0.80, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.5},
    [2] = { hash = `WEAPON_PISTOL_MK2`, recoil = 0.70, rightLeftRecoil = 1.00, vehicleRecoil = 0.80, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.95},
    [3] = { hash = `WEAPON_COMBATPISTOL`, recoil = 1.40, rightLeftRecoil = 1.00, vehicleRecoil = 0.80, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.50},
    ...
    [6] = { hash = `WEAPON_PISTOL50`, recoil = 4.50, rightLeftRecoil = 1.00, vehicleRecoil = 0.80, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.50},
    [7] = { hash = `WEAPON_SNSPISTOL`, recoil = 1.30, rightLeftRecoil = 1.00, vehicleRecoil = 1.10, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.80},
    ...
    [9] = { hash = `WEAPON_HEAVYPISTOL`, recoil = 1.50, rightLeftRecoil = 1.00, vehicleRecoil = 1.10, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.63},
    [10] = { hash = `WEAPON_VINTAGEPISTOL`, recoil = 1.30, rightLeftRecoil = 1.00, vehicleRecoil = 0.80, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.50},
    ...
    --Submachine Guns--
    [20] = { hash = `WEAPON_MICROSMG`, recoil = 1.40, rightLeftRecoil = 1.00, vehicleRecoil = 1.10, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.40},
    [21] = { hash = `WEAPON_SMG`, recoil = 1.00, rightLeftRecoil = 1.00, vehicleRecoil = 1.10, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.60, suppressorMultiplier = 0.72, damageMultiplier = 0.80},
    ...
    [26] = { hash = `WEAPON_MINISMG`, recoil = 0.30, rightLeftRecoil = 1.00, vehicleRecoil = 1.10, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.75},
    ...
    --Shotguns--
    [28] = { hash = `WEAPON_PUMPSHOTGUN`, recoil = 2.50, rightLeftRecoil = 1.00, vehicleRecoil = 1.10, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.60, suppressorMultiplier = 0.72, damageMultiplier = 0.20},
    [29] = { hash = `WEAPON_PUMPSHOTGUN_MK2`, recoil = 3.50, rightLeftRecoil = 1.00, vehicleRecoil = 1.10, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.40},
    ...
    [31] = { hash = `WEAPON_ASSAULTSHOTGUN`, recoil = 6.00, rightLeftRecoil = 1.00, vehicleRecoil = 1.10, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.25},
    [32] = { hash = `WEAPON_BULLPUPSHOTGUN`, recoil = 8.00, rightLeftRecoil = 1.00, vehicleRecoil = 1.10, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.40},
    ...
    [34] = { hash = `WEAPON_HEAVYSHOTGUN`, recoil = 6.00, rightLeftRecoil = 1.00, vehicleRecoil = 1.10, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.30},
    ...
    [36] = { hash = `WEAPON_AUTOSHOTGUN`, recoil = 8.00, rightLeftRecoil = 1.00, vehicleRecoil = 1.10, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.30},
    ...
    --Assault Rifles--
    [38] = { hash = `WEAPON_ASSAULTRIFLE`, recoil = 1.00, rightLeftRecoil = 1.00, vehicleRecoil = 1.10, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.40, suppressorMultiplier = 0.72, damageMultiplier = 1.10},
    [39] = { hash = `WEAPON_ASSAULTRIFLE_MK2`, recoil = 0.80, rightLeftRecoil = 1.00, vehicleRecoil = 1.10, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.60},
    [40] = { hash = `WEAPON_CARBINERIFLE`, recoil = 0.70, rightLeftRecoil = 1.00, vehicleRecoil = 1.10, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.40, suppressorMultiplier = 0.72, damageMultiplier = 0.65},
    [41] = { hash = `WEAPON_CARBINERIFLE_MK2`, recoil = 0.60, rightLeftRecoil = 1.00, vehicleRecoil = 1.10, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.45},
    [42] = { hash = `WEAPON_ADVANCEDRIFLE`, recoil = 1.00, rightLeftRecoil = 1.00, vehicleRecoil = 1.10, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.45},
    [43] = { hash = `WEAPON_SPECIALCARBINE`, recoil = 1.30, rightLeftRecoil = 1.00, vehicleRecoil = 1.10, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.50},
    [44] = { hash = `WEAPON_SPECIALCARBINE_MK2`, recoil = 1.00, rightLeftRecoil = 1.00, vehicleRecoil = 1.10, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.60},
    [45] = { hash = `WEAPON_BULLPUPRIFLE`, recoil = 0.90, rightLeftRecoil = 1.00, vehicleRecoil = 1.10, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.25},
    [46] = { hash = `WEAPON_BULLPUPRIFLE_MK2`, recoil = 0.50, rightLeftRecoil = 1.00, vehicleRecoil = 1.10, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.80},
    ...
    --Light Machine Guns--
    [49] = { hash = `WEAPON_MG`, recoil = 1.80, rightLeftRecoil = 1.00, vehicleRecoil = 1.10, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.55},
    ...
    --EXTRA--
    [94] = { hash = `WEAPON_ASSAULTSMG`, recoil = 1.00, rightLeftRecoil = 1.00, vehicleRecoil = 1.10, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.40},
    [95] = { hash = `WEAPON_M4A4`, recoil = 1.0, rightLeftRecoil = 0.10, vehicleRecoil = 1.10, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.60},
    [96] = { hash = `WEAPON_NSR`, recoil = 1.10, rightLeftRecoil = 0.10, vehicleRecoil = 1.10, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.50},
    ...
    [98] = { hash = `WEAPON_P90`, recoil = 1.00, rightLeftRecoil = 0.10, vehicleRecoil = 1.10, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.60},
    [99] = { hash = `WEAPON_HEAVYRIFLE`, recoil = 1.00, rightLeftRecoil = 1.00, vehicleRecoil = 1.10, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.25},
    [100] = { hash = `WEAPON_LTL`, recoil = 2.50, rightLeftRecoil = 1.00, vehicleRecoil = 1.10, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.60, suppressorMultiplier = 0.72, damageMultiplier = 0.20},
    [101] = { hash = `WEAPON_HKE1`, recoil = 0.10, rightLeftRecoil = 0.10, vehicleRecoil = 1.10, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.80},
    [102] = { hash = `WEAPON_GLOCK17`, recoil = 1.40, rightLeftRecoil = 1.00, vehicleRecoil = 0.80, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.60},

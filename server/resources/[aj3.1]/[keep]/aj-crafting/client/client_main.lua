...
RegisterNetEvent('aj-crafting:client:start_crafting', function(data, item_config)
     local plyped = PlayerPedId()

     TriggerEvent('animations:client:EmoteCommandStart', { "mechanic4" })
     makeEntityFaceCoord(plyped, Workbench.coords)
     AJFW.Functions.Progressbar("aj_Crafting", "Crafting ", item_config.crafting.duration * 1000, false, false, {

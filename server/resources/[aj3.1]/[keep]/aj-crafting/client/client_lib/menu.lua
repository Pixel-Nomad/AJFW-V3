...
local function updatePlayerBluePrints()
     AJFW.Functions.TriggerCallback('aj-crafting:server:get_player_blueprints', function(result)
     ...
     for _, v in ipairs(benches) do
          ...
          if distance < 2.6 then
               ...
               if isJobAllowed(v.gang, 'gang') or isJobAllowed(v.job, 'job') then
                    ...
                    AJFW.Functions.Notify(Lang:t('error.not_authorized'), 'error')
                    return false
               end
...
function menu:player_crafting_information()
     AJFW.Functions.TriggerCallback('aj-crafting:server:get_player_information', function(result)
...
function menu:crafting_items_list(data)
     ...
     local craftingrep = AJFW.Functions.GetPlayerData().metadata.craftingrep
     local Menu = {}
...
function menu:crafting_menu(item, data)
     ...
     local Menu = {
          ...
          },
          {
               ...
               action = function()
                    TriggerServerEvent('aj-crafting:server:craft_item', {
                         type = 'sell',
          ...
          },
          {
               ...
               action = function()
                    TriggerServerEvent('aj-crafting:check_materials_list', {
                         type = 'sell',
                         item = item,
                         id = Workbench.id
                    })
...
function AjMenu:main_categories()
     -- workbench.recipes.categories
     if Workbench == nil then return end
     local Menu = {}
     Menu[#Menu + 1] = {
          ...
          if category.sub_categories then
               Menu[#Menu + 1] = {
                    ...
                    params = {
                         ...
                         event = 'aj-crafting:client_lib:sub_categories'
                    }
               }
          else
               Menu[#Menu + 1] = {
                    ...
                    params = {
                         ...
                         event = 'aj-crafting:client_lib:crafting_items_list'
                    }
               }
          end
     end
     ...
     Menu[#Menu + 1] = {
          ...
          icon = 'fa-solid fa-circle-info',
          params = {
               event = 'aj-crafting:client_lib:player_crafting_information'
          },
     }
...
function AjMenu:player_crafting_information()
     AJFW.Functions.TriggerCallback('aj-crafting:server:get_player_information', function(result)
          local job_sub = Lang:t("menu.job_sub")
          job_sub = string.format(job_sub, result.job.name, result.job.grade.name)
          local Menu = {
               {
                    header = Lang:t("menu.back"),
                    params = {
                         event = 'aj-crafting:client_lib:main_categories'
                    }
               },
               {
                    header = Lang:t('menu.your_name'),
...
function AjMenu:sub_categories(args)
     -- args[1] is data used by current menu
     -- args[2] is previous menu cached data (make possible to go back in menus)
     local Menu = {}
     Menu[#Menu + 1] = {
...
function AjMenu:crafting_items_list(data)
     local items = search_for_items_in_category(data[1])
     local craftingrep = AJFW.Functions.GetPlayerData().metadata.craftingrep
     local Menu = {}
               ...
               if craftingrep >= item.item_settings.level then
                    Menu[#Menu + 1] = {
                         ...
                         params = {
                              ...
                              event = 'aj-crafting:client_lib:crafting_menu'
                         }
                    }
               end
          else
...
function AjMenu:crafting_menu(args)
     local item = args[1]
     local entity, box, cam
     ...
     local Menu = {
          ...
          },
          {
               ...
               params = {
                    ...
                    event    = 'aj-crafting:server:craft_item',
                    isServer = true
               }
          },
          {
               ...
               params = {
                    ...
                    event = 'aj-crafting:client_lib:check_materials_list'
               }
          },
          {
               header = Lang:t('menu.leave'),
...
AddEventHandler('aj-crafting:client_lib:main_categories', function()
     Open_menu()
end)

AddEventHandler('aj-crafting:client_lib:sub_categories', function(args)
     AjMenu:sub_categories(args)
end)

AddEventHandler('aj-crafting:client_lib:player_crafting_information', function(args)
     AjMenu:player_crafting_information()
end)

AddEventHandler('aj-crafting:client_lib:crafting_items_list', function(args)
     nui_traker = true
     AjMenu:crafting_items_list(args)
end)

AddEventHandler('aj-crafting:client_lib:crafting_menu', function(args)
     AjMenu:crafting_menu(args)
end)

-- crafting_menu
AddEventHandler('aj-crafting:client_lib:check_materials_list', function(args)
     TriggerServerEvent('aj-crafting:check_materials_list', { type = args[1], item = args[2], id = args[3] })
end)

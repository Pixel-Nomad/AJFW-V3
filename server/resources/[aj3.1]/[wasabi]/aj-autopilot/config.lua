...
Config.NormalSpeed = 40.0 -- Normal Speed
...
Config.NormalKeybind = false -- Enable Keymapping for toggling normal driving autopilot
Config.DefaultKey = "i" -- Default keybind to toggle normal driving autopilot
Config.CrazyKeybind = false -- Enable Keymapping for toggling crazy driving autopilot

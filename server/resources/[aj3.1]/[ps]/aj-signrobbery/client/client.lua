...
AddEventHandler('AJFW:Client:OnPlayerLoaded', function()
    AJFW.Functions.TriggerCallback('aj-signrobbery:server:GetObjects', function(incObjects)
        objects = incObjects
    end)
end)
...
local function AlertCops()
    ...
    --TriggerServerEvent('police:server:policeAlert', 'Sign being stolen') -- Default AJFW Dispatch
    exports['aj-dispatch']:SignRobbery() -- ps-dispatch
end
...
--Events
RegisterNetEvent("aj-signrobbery:client:StopSign", function(data)
    ...
    exports['aj-hacks']:Circle(function(success)
        if success then
            ...
            AJFW.Functions.Progressbar("robbing_sign", "Stealing Stop Sign..", math.random(5000, 7000), false, true, {
                ...
                TriggerServerEvent("aj-signrobbery:server:delete", object)
                AlertCops()
            end)
        end
    end, 2, 6)
...
RegisterNetEvent("aj-signrobbery:client:WalkingManSign", function(data)
    local ped = PlayerPedId()
    exports['aj-hacks']:Circle(function(success)
        if success then
            loadAnimDict("amb@prop_human_bum_bin@base")
            TaskPlayAnim(ped, "amb@prop_human_bum_bin@base", "base", 8.0, 1.0, -1, 49, 0, 0, 0, 0)
            AJFW.Functions.Progressbar("robbing_sign", "Stealing Pedestrian Sign..", math.random(5000, 7000), false, true, {
                disableMovement = true,
                disableCarMovement = true,
                disableMouse = false,
                disableCombat = true,
...
RegisterNetEvent("aj-signrobbery:client:DontBlockIntersectionSign", function(data)
    local ped = PlayerPedId()
    exports['aj-hacks']:Circle(function(success)
        if success then
            loadAnimDict("amb@prop_human_bum_bin@base")
            TaskPlayAnim(ped, "amb@prop_human_bum_bin@base", "base", 8.0, 1.0, -1, 49, 0, 0, 0, 0)
            AJFW.Functions.Progressbar("robbing_sign", "Stealing Intersection Sign..", math.random(5000, 7000), false, true, {
                disableMovement = true,
                disableCarMovement = true,
                disableMouse = false,
                disableCombat = true,
...
RegisterNetEvent("aj-signrobbery:client:UTurnSign", function(data)
    local ped = PlayerPedId()
    exports['aj-hacks']:Circle(function(success)
        if success then
            loadAnimDict("amb@prop_human_bum_bin@base")
            TaskPlayAnim(ped, "amb@prop_human_bum_bin@base", "base", 8.0, 1.0, -1, 49, 0, 0, 0, 0)
            AJFW.Functions.Progressbar("robbing_sign", "Stealing U Turn Sign..", math.random(5000, 7000), false, true, {
                disableMovement = true,
                disableCarMovement = true,
                disableMouse = false,
                disableCombat = true,
...
RegisterNetEvent("aj-signrobbery:client:NoParkingSign", function(data)
    local ped = PlayerPedId()
    exports['aj-hacks']:Circle(function(success)
        if success then
            loadAnimDict("amb@prop_human_bum_bin@base")
            TaskPlayAnim(ped, "amb@prop_human_bum_bin@base", "base", 8.0, 1.0, -1, 49, 0, 0, 0, 0)
            AJFW.Functions.Progressbar("robbing_sign", "Stealing No Parking Sign..", math.random(5000, 7000), false, true, {
                disableMovement = true,
                disableCarMovement = true,
                disableMouse = false,
                disableCombat = true,
...
RegisterNetEvent("aj-signrobbery:client:LeftTurnSign", function(data)
    local ped = PlayerPedId()
    exports['aj-hacks']:Circle(function(success)
        if success then
            loadAnimDict("amb@prop_human_bum_bin@base")
            TaskPlayAnim(ped, "amb@prop_human_bum_bin@base", "base", 8.0, 1.0, -1, 49, 0, 0, 0, 0)
            AJFW.Functions.Progressbar("robbing_sign", "Stealing Left Turn Sign..", math.random(5000, 7000), false, true, {
                disableMovement = true,
                disableCarMovement = true,
                disableMouse = false,
                disableCombat = true,
...
RegisterNetEvent("aj-signrobbery:client:RightTurnSign", function(data)
    local ped = PlayerPedId()
    exports['aj-hacks']:Circle(function(success)
        if success then
            loadAnimDict("amb@prop_human_bum_bin@base")
            TaskPlayAnim(ped, "amb@prop_human_bum_bin@base", "base", 8.0, 1.0, -1, 49, 0, 0, 0, 0)
            AJFW.Functions.Progressbar("robbing_sign", "Stealing Right Turn Sign..", math.random(5000, 7000), false, true, {
                disableMovement = true,
                disableCarMovement = true,
                disableMouse = false,
                disableCombat = true,
...
RegisterNetEvent("aj-signrobbery:client:NoTrespassingSign", function(data)
    local ped = PlayerPedId()
    exports['aj-hacks']:Circle(function(success)
        if success then
            loadAnimDict("amb@prop_human_bum_bin@base")
            TaskPlayAnim(ped, "amb@prop_human_bum_bin@base", "base", 8.0, 1.0, -1, 49, 0, 0, 0, 0)
            AJFW.Functions.Progressbar("robbing_sign", "Stealing No Trespassing Sign..", math.random(5000, 7000), false, true, {
                disableMovement = true,
                disableCarMovement = true,
                disableMouse = false,
                disableCombat = true,
...
RegisterNetEvent("aj-signrobbery:client:YieldSign", function(data)
    local ped = PlayerPedId()
    exports['aj-hacks']:Circle(function(success)
        if success then
            loadAnimDict("amb@prop_human_bum_bin@base")
            TaskPlayAnim(ped, "amb@prop_human_bum_bin@base", "base", 8.0, 1.0, -1, 49, 0, 0, 0, 0)
            AJFW.Functions.Progressbar("robbing_sign", "Stealing Yield Sign..", math.random(5000, 7000), false, true, {
                disableMovement = true,
                disableCarMovement = true,
                disableMouse = false,
                disableCombat = true,
...
--Emote Events
RegisterNetEvent("aj-signrobbery:use:StopSign", function(src)
...
RegisterNetEvent("aj-signrobbery:use:WalkingManSign", function(src) 
    if not holdingSign then
        holdingSign = true
...
RegisterNetEvent("aj-signrobbery:use:DontBlockIntersectionSign", function(src)
    if not holdingSign then
        holdingSign = true
...
RegisterNetEvent("aj-signrobbery:use:UturnSign", function(src)
    if not holdingSign then
        holdingSign = true
...
RegisterNetEvent("aj-signrobbery:use:NoParkingSign", function(src)
    if not holdingSign then
        holdingSign = true
...
RegisterNetEvent("aj-signrobbery:use:LeftTurnSign", function(src)
    if not holdingSign then
        holdingSign = true
...
RegisterNetEvent("aj-signrobbery:use:RightTurnSign", function(src)
    if not holdingSign then
        holdingSign = true
...
RegisterNetEvent("aj-signrobbery:use:NoTrespassingSign", function(src)
    if not holdingSign then
        holdingSign = true
...
RegisterNetEvent("aj-signrobbery:use:YieldSign", function(src)
    if not holdingSign then
        holdingSign = true
...
--Target Exports
CreateThread(function()
    exports['aj-target']:AddTargetModel('prop_sign_road_01a', {
        options = {
            {
                type = 'client',
                event = "aj-signrobbery:client:StopSign",
    ...
    exports['aj-target']:AddTargetModel('prop_sign_road_05a', {
        options = {
            {
                type = 'client',
                event = "aj-signrobbery:client:WalkingManSign",
                icon = 'fas fa-user-secret',
                label = 'Steal Sign',
            }
        },
    ...
    exports['aj-target']:AddTargetModel('prop_sign_road_03e', {
        options = {
            {
                type = 'client',
                event = "aj-signrobbery:client:DontBlockIntersectionSign",
                icon = 'fas fa-user-secret',
                label = 'Steal Sign',
            }
        },
    ...
    exports['aj-target']:AddTargetModel('prop_sign_road_03m', {
        options = {
            {
                type = 'client',
                event = "aj-signrobbery:client:UTurnSign",
                icon = 'fas fa-user-secret',
                label = 'Steal Sign',
            }
        },
    ...
    exports['aj-target']:AddTargetModel('prop_sign_road_04a', {
        options = {
            {
                type = 'client',
                event = "aj-signrobbery:client:NoParkingSign",
                icon = 'fas fa-user-secret',
                label = 'Steal Sign',
            }
        },
    ...
    exports['aj-target']:AddTargetModel('prop_sign_road_05e', {
        options = {
            {
                type = 'client',
                event = "aj-signrobbery:client:LeftTurnSign",
                icon = 'fas fa-user-secret',
                label = 'Steal Sign',
            }
        },
    ...
    exports['aj-target']:AddTargetModel('prop_sign_road_05f', {
        options = {
            {
                type = 'client',
                event = "aj-signrobbery:client:RightTurnSign",
                icon = 'fas fa-user-secret',
                label = 'Steal Sign',
            }
        },
    ...
    exports['aj-target']:AddTargetModel('prop_sign_road_restriction_10', {
        options = {
            {
                type = 'client',
                event = "aj-signrobbery:client:NoTrespassingSign",
                icon = 'fas fa-user-secret',
                label = 'Steal Sign',
            }
        },
    ...
    exports['aj-target']:AddTargetModel('prop_sign_road_02a', {
        options = {
            {
                type = 'client',
                event = "aj-signrobbery:client:YieldSign",
                icon = 'fas fa-user-secret',
                label = 'Steal Sign',
            }
        },
...
RegisterNetEvent("SignRobbery:CloseMenu", function() exports['aj-menu']:closeMenu() end)

--Export For Scrapping The Sign
exports['aj-target']:AddBoxZone("SignRobberyScrap", vector3(2332.43, 3026.89, 48.15), 1.5, 1, {

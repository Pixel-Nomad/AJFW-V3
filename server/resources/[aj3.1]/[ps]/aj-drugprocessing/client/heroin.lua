...
local function ProcessHeroin()
	...
	AJFW.Functions.Progressbar("search_register", Lang:t("progressbar.processing"), 15000, false, true, {
		...
		TriggerServerEvent('aj-drugprocessing:processPoppyResin')
...
RegisterNetEvent('aj-drugprocessing:ProcessPoppy', function()
...
RegisterNetEvent("aj-drugprocessing:processHeroin",function()
	AJFW.Functions.TriggerCallback('aj-drugprocessing:validate_items', function(result)
		if result.ret then
			ProcessHeroin()
		else
...
RegisterNetEvent("aj-drugprocessing:pickHeroin", function()
	local playerPed = PlayerPedId()
	...
	if nearbyObject and IsPedOnFoot(playerPed) then
		...
		AJFW.Functions.Progressbar("search_register", Lang:t("progressbar.collecting"), 10000, false, true, {
			...
			TriggerServerEvent('aj-drugprocessing:pickedUpPoppy')
			isPickingUp = false

...
RegisterNetEvent("aj-drugprocessing:client:hydrochloricacid", function()
	...
	if nearbyObject and IsPedOnFoot(playerPed) then
		...
		AJFW.Functions.Progressbar("search_register", Lang:t("progressbar.collecting"), 10000, false, true, {
			...
			TriggerServerEvent('aj-drugprocessing:pickedUpHydrochloricAcid')
			isPickingUp = false
		end, function()
			ClearPedTasks(playerPed)
			isPickingUp = false

...
local function ProcessCoke()
	...
	AJFW.Functions.Progressbar("search_register", Lang:t("progressbar.processing"), 15000, false, true, {
		...
		TriggerServerEvent('aj-drugprocessing:processCocaLeaf')
...
local function CutCokePowder()
	...
	AJFW.Functions.Progressbar("search_register", Lang:t("progressbar.processing"), 15000, false, true, {
		...
		TriggerServerEvent('aj-drugprocessing:processCocaPowder')
...
local function ProcessBricks()
	...
	AJFW.Functions.Progressbar("search_register", Lang:t("progressbar.packing"), 15000, false, true, {
		...
		TriggerServerEvent('aj-drugprocessing:processCocaBrick')
...
RegisterNetEvent('aj-drugprocessing:ProcessCocaFarm', function()
...
RegisterNetEvent('aj-drugprocessing:ProcessCocaPowder', function()
	local coords = GetEntityCoords(PlayerPedId())
	local amount = 10
	local amount2 = 5
...
RegisterNetEvent('aj-drugprocessing:ProcessBricks', function()
...
RegisterNetEvent('aj-drugprocessing:EnterCWarehouse', function()
	local ped = PlayerPedId()
...
RegisterNetEvent('aj-drugprocessing:ExitCWarehouse', function()
	local ped = PlayerPedId()
	local pos = GetEntityCoords(ped)
...
RegisterNetEvent('aj-drugprocessing:pickCocaLeaves', function()
	local playerPed = PlayerPedId()
	...
	if nearbyObject and IsPedOnFoot(playerPed) then
		if not isPickingUp then
			...
			AJFW.Functions.Progressbar("search_register", Lang:t("progressbar.collecting"), 10000, false, true, {
				...
				TriggerServerEvent('aj-drugprocessing:pickedUpCocaLeaf')
				isPickingUp = false
			end, function()
				ClearPedTasks(playerPed)
				isPickingUp = false

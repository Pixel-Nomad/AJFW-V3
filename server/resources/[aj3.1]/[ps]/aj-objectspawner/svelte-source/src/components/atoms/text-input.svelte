<script lang="ts">
  ...
  export let maxLength: number = 25;
  ...
  //    dark:focus:border-blue-500"
	...
	<input
    class="chrome-input bg-[var(--aj-bg)] text-white rounded-sm focus:ring-2 focus:ring-[var(--aj-primary)] ring-blue-200 pl-3 py-2 placeholder-white"
		bind:value
    maxlength={maxLength}
		type="text"
		{placeholder}

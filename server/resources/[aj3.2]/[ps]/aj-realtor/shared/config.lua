...
-- Change the uniqueness and the usability inside aj-base -> items.lua to TRUE
-- add this item to a shop or anything else!

--Commisions is handled in aj-housing config.
...
Config.RealtorPerms = {
    ...
    sellProperty = 1, --minimum grade to sell property | default 0

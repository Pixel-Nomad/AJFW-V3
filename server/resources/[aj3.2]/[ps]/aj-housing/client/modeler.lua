...
Modeler = {
    ...
    UpdateFurniture = function (self, item)
        ...
        TriggerServerEvent("aj-housing:server:updateFurniture", self.property_id, newFurniture)
    end,
	...
	-- If the cart is empty, return notify
        ...
        TriggerServerEvent("aj-housing:server:buyFurniture", self.property_id, items, totalPrice)
    ...
    RemoveOwnedItem = function (self, data)
        ...
        if item ~= nil then
            ...
            TriggerServerEvent("aj-housing:server:removeFurniture", self.property_id, item.id)
        end
    end,
}

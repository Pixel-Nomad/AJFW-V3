...
RegisterNetEvent('aj-housing:server:migratehouses', function()
    ...
    CreateThread(function()
        for i = 1, #qbHouseLocations do
            ...
            local clientData = lib.callback.await("aj-housing:client:getclientdata", src, {coords = houseCoords.enter})

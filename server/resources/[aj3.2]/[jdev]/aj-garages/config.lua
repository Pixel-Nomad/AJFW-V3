...
Config.TrackVehicleByPlateCommandPermissionLevel = 'dev' -- Permission level required to use /trackvehicle <plate>, false for anyone / everyone
...
Config.FuelScript = 'aj-fuel' -- change to lj-fuel / ps-fuel if you use lj-fuel / ps-fuel or something else if you use any other LegcyFuel compatible script
...
Config.HouseGarageCategories = {'car', 'motorcycle', 'other', 'emergency'} -- Which categories are allowed to be parked at a house garage
...
Config.Garages = {
    ...
    ['leigonsquarealley'] = {
        ...
        label = 'Legion Square Alley Parking',
        showBlip = true,

...
RegisterNetEvent('mcd:caramel', function()
    AJFW.Functions.TriggerCallback('AJFW:HasItem', function(result)
        if result then
            ...
            AJFW.Functions.Notify("You don't have empty cup", "error")
        end
...
RegisterNetEvent('mcd:icetea', function()
    AJFW.Functions.TriggerCallback('AJFW:HasItem', function(result)
        if result then
            ...
            AJFW.Functions.Notify("You don't have empty glass", "error")
        end
...
function StrawberryFilling()
    ...
    TriggerServerEvent("AJFW:Server:RemoveItem", "mcd-glass", 1)
    TriggerEvent("inventory:client:ItemBox", AJFW.Shared.Items["mcd-glass"], "remove")
    TriggerServerEvent("InteractSound_SV:PlayOnSource", "sodaop", 0.8)
    AJFW.Functions.Progressbar("empty_bottle", "Filling Strawberry Banana Smoothie ..",'pink', 8000, false, true, {
        ...
        TriggerServerEvent("AJFW:Server:AddItem", "mcd-strawberry", 1)
        TriggerEvent("inventory:client:ItemBox", AJFW.Shared.Items["mcd-strawberry"], "add")
    end, function() -- Cancel
        StopAnimTask(PlayerPedId(), "amb@prop_human_bum_shopping_cart@male@idle_a", "idle_c", 1.0)
        AJFW.Functions.Notify("Fail", "error")
    end)
end
...
function MangoFilling()
    ...
    TriggerEvent("inventory:client:ItemBox", AJFW.Shared.Items["mcd-glass"], "remove")
    TriggerServerEvent("InteractSound_SV:PlayOnSource", "sodaop", 0.8)
    AJFW.Functions.Progressbar("empty_bottle", "Filling Mango Pineapple Smoothie ..",'yellow', 8000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
        ...
        StopAnimTask(PlayerPedId(), "amb@prop_human_bum_shopping_cart@male@idle_a", "idle_c", 1.0)
        TriggerServerEvent("AJFW:Server:AddItem", "mcd-mango", 1)
        TriggerEvent("inventory:client:ItemBox", AJFW.Shared.Items["mcd-mango"], "add")
    end, function() -- Cancel
        StopAnimTask(PlayerPedId(), "amb@prop_human_bum_shopping_cart@male@idle_a", "idle_c", 1.0)
        AJFW.Functions.Notify("Fail", "error")
    end)
...
function iceFilling()
    ...
    TriggerEvent("inventory:client:ItemBox", AJFW.Shared.Items["mcd-glass"], "remove")
    TriggerServerEvent("InteractSound_SV:PlayOnSource", "sodaop", 0.8)
    AJFW.Functions.Progressbar("empty_bottle", "Filling Ice tea ..",'white', 8000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
        ...
        StopAnimTask(PlayerPedId(), "amb@prop_human_bum_shopping_cart@male@idle_a", "idle_c", 1.0)
        TriggerServerEvent("AJFW:Server:AddItem", "mcd-icetea", 1)
        TriggerEvent("inventory:client:ItemBox", AJFW.Shared.Items["mcd-icetea"], "add")
    end, function() -- Cancel
        StopAnimTask(PlayerPedId(), "amb@prop_human_bum_shopping_cart@male@idle_a", "idle_c", 1.0)
        AJFW.Functions.Notify("Fail", "error")
    end)
...
function icedFilling()
    ...
    TriggerEvent("inventory:client:ItemBox", AJFW.Shared.Items["mcd-glass"], "remove")
    TriggerServerEvent("InteractSound_SV:PlayOnSource", "sodaop", 0.8)
    AJFW.Functions.Progressbar("empty_bottle", "Filling Iced Latte ..",'white', 8000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
        ...
        StopAnimTask(PlayerPedId(), "amb@prop_human_bum_shopping_cart@male@idle_a", "idle_c", 1.0)
        TriggerServerEvent("AJFW:Server:AddItem", "mcd-iced", 1)
        TriggerEvent("inventory:client:ItemBox", AJFW.Shared.Items["mcd-iced"], "add")
    end, function() -- Cancel
        StopAnimTask(PlayerPedId(), "amb@prop_human_bum_shopping_cart@male@idle_a", "idle_c", 1.0)
        AJFW.Functions.Notify("Fail", "error")
    end)
...
function cappuccinoFilling()
    ...
    TriggerServerEvent("AJFW:Server:RemoveItem", "mcd-cup", 1)
    TriggerEvent("inventory:client:ItemBox", AJFW.Shared.Items["mcd-cup"], "remove")
    TriggerServerEvent("InteractSound_SV:PlayOnSource", "cmaking", 0.8)
    AJFW.Functions.Progressbar("empty_bottle", "Filling Cappuccino ..",'white', 10000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
        ...
        StopAnimTask(PlayerPedId(), "amb@prop_human_bum_shopping_cart@male@idle_a", "idle_c", 1.0)
        TriggerServerEvent("AJFW:Server:AddItem", "mcd-cappuccino", 1)
        TriggerEvent("inventory:client:ItemBox", AJFW.Shared.Items["mcd-cappuccino"], "add")
    end, function() -- Cancel
        StopAnimTask(PlayerPedId(), "amb@prop_human_bum_shopping_cart@male@idle_a", "idle_c", 1.0)
        AJFW.Functions.Notify("Fail", "error")
    end)
...
function ChocolateFilling()
    ...
    TriggerEvent("inventory:client:ItemBox", AJFW.Shared.Items["mcd-cup"], "remove")
    TriggerServerEvent("InteractSound_SV:PlayOnSource", "cmaking", 0.8)
    AJFW.Functions.Progressbar("empty_bottle", "Filling Hot Chocolate ..",'white', 10000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
        ...
        StopAnimTask(PlayerPedId(), "amb@prop_human_bum_shopping_cart@male@idle_a", "idle_c", 1.0)
        TriggerServerEvent("AJFW:Server:AddItem", "mcd-hchocolate", 1)
        TriggerEvent("inventory:client:ItemBox", AJFW.Shared.Items["mcd-hchocolate"], "add")
    end, function() -- Cancel
        StopAnimTask(PlayerPedId(), "amb@prop_human_bum_shopping_cart@male@idle_a", "idle_c", 1.0)
        AJFW.Functions.Notify("Fail", "error")
    end)
...
function CaramelFilling()
    ...
    TriggerEvent("inventory:client:ItemBox", AJFW.Shared.Items["mcd-cup"], "remove")
    TriggerServerEvent("InteractSound_SV:PlayOnSource", "cmaking", 0.8)
    AJFW.Functions.Progressbar("empty_bottle", "Filling Caramel Latte ..",'white', 10000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
        ...
        StopAnimTask(PlayerPedId(), "amb@prop_human_bum_shopping_cart@male@idle_a", "idle_c", 1.0)
        TriggerServerEvent("AJFW:Server:AddItem", "mcd-caramel", 1)
        TriggerEvent("inventory:client:ItemBox", AJFW.Shared.Items["mcd-caramel"], "add")
    end, function() -- Cancel
        StopAnimTask(PlayerPedId(), "amb@prop_human_bum_shopping_cart@male@idle_a", "idle_c", 1.0)
        AJFW.Functions.Notify("Fail", "error")
    end)
...
Citizen.CreateThread(function()
    ---Tables
    exports['aj-target']:AddBoxZone("McdTable", vector3(75.7, 282.19, 110.21), 1.0, 1.6, { name="McdTable", heading = 91.0, debugPoly=false, minZ=21.49, maxZ=22.89 }, 
        { options = { {  event = "mcd-table:Stash", icon = "fas fa-box-open", label = "Table", stash = "Table_1" }, }, distance = 2.0 })
    -- exports['aj-target']:AddBoxZone("McdTable2", vector3(-573.44, -1063.45, 22.34), 1.9, 1.0, { name="McdTable", heading = 91.0, debugPoly=debug, minZ=21.49, maxZ=22.89 }, 
    --     { options = { {  event = "mcd-table:Stash", icon = "fas fa-box-open", label = "Table", stash = "Table_2" }, }, distance = 2.0 })
    -- exports['aj-target']:AddBoxZone("McdTable3", vector3(-573.41, -1067.09, 22.49), 1.9, 1.0, { name="McdTable", heading = 91.0, debugPoly=debug, minZ=21.49, maxZ=22.89 }, 
    --     { options = { {  event = "mcd-table:Stash", icon = "fas fa-box-open", label = "Table", stash = "Table_3" }, }, distance = 2.0 })
    -- exports['aj-target']:AddBoxZone("McdTable4", vector3(-578.68, -1051.09, 22.35), 1.2, 0.9, { name="McdTable", heading = 91.0, debugPoly=debug, minZ=21.49, maxZ=22.89 }, 

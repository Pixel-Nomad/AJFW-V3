...
Config.CheckPoints = {

	{
		...
		Action = function(playerPed, vehicle, setCurrentZoneType)
			AJFW.Functions.Notify("Next Point Speed - "..Config.SpeedLimits['residence'].." ", "success", 5000)
...

	{
		...
		Action = function(playerPed, vehicle, setCurrentZoneType)
			AJFW.Functions.Notify('Go to Next Point', "success", 5000)
		end
	},

	{
		...
		Action = function(playerPed, vehicle, setCurrentZoneType)
			Citizen.CreateThread(function()
				...
				AJFW.Functions.Notify('Stop For Ped', "error", 5000)
...

	{
		...
		Action = function(playerPed, vehicle, setCurrentZoneType)
			...
			Citizen.CreateThread(function()
				...
				AJFW.Functions.Notify("Stop Look Left - "..Config.SpeedLimits['town'].." ", "error", 5000)
				PlaySound(-1, 'RACE_PLACED', 'HUD_AWARDS', false, 0, true)
				FreezeEntityPosition(vehicle, true)
				Citizen.Wait(6000)
				...
				AJFW.Functions.Notify('Good Turn Right', "success", 5000)
			end)
		end
	},

	{
		...
		Action = function(playerPed, vehicle, setCurrentZoneType)
			...
			AJFW.Functions.Notify('Watch Traffic Light Son', "error", 5000)
		end
	},
...

	{
		...
		Action = function(playerPed, vehicle, setCurrentZoneType)
			...
			AJFW.Functions.Notify('Stop For Passing', "error", 5000)
			PlaySound(-1, 'RACE_PLACED', 'HUD_AWARDS', false, 0, true)
			FreezeEntityPosition(vehicle, true)
			Citizen.Wait(6000)
			FreezeEntityPosition(vehicle, false)
...

	{
		...
		Action = function(playerPed, vehicle, setCurrentZoneType)
			...
			AJFW.Functions.Notify("Free way time - "..Config.SpeedLimits['freeway'].." ", "error", 5000)
			PlaySound(-1, 'RACE_PLACED', 'HUD_AWARDS', false, 0, true)
		end
	},
...

	{
		...
		Action = function(playerPed, vehicle, setCurrentZoneType)
			...
			AJFW.Functions.Notify("In Town Speed - "..Config.SpeedLimits['town'].." ", "error", 5000)
		end
	},

	{
		...
		Action = function(playerPed, vehicle, setCurrentZoneType)
			...
			AJFW.Functions.Notify('Stay Alert', "error", 5000)
			PlaySound(-1, 'RACE_PLACED', 'HUD_AWARDS', false, 0, true)
		end
	},

...
--                     insidePoint = true
--                     TriggerEvent("AJFW:Notify","You are in High Security Area", "error")
...
--                             TriggerEvent("AJFW:Notify","You left High Security Area", "error")
--                         end
--                         Wait(1000)
--                     end
--                 end
...
RegisterNetEvent("client:getpos", function ()
    ...
    TriggerEvent("AJFW:Notify",streetLabel, "error")
end)

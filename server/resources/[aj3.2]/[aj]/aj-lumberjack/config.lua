...
-- Blips
LumberDepo = {
    targetZone = vector3(-841.81, 5401.28, 34.62),                 -- aj-target vector
    targetHeading = 321.41,                                         -- aj-target box zone
    coords = vector4(-841.81, 5401.28, 33.62, 321.41),             -- Move Location (Ped and blip)
...
Config.Sell = {
    ["tree_lumber"] = {
        ["price"] = math.random(80, 120)                             -- Seller Price
    },
    ["tree_bark"] = {
...
Config.Alerts = {
    ...
    ['vehicle_header'] = 'Lumber Jack',
    ['vehicle_get'] = 'Logger Location',
    ['vehicle_text'] = 'Get Location',

...
Config.CircleZones = {
	...
	-- WeedField = {coords = vector3(-911.86, 4823.34, 306.29), name = 'blip_weedfield', color = 25, sprite = 496, radius = 100.0},
	WeedField = {coords = vector3(2442.65, -1961.7, 60.57), name = 'blip_weedfield', color = 25, sprite = 496, radius = 100.0},

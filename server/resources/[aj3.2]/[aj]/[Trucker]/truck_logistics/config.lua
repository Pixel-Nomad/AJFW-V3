...
Config.contratos = {
	...
	['preco_por_km_max'] = 340,				-- Maximum price per kilometer of the contract
	['multiplicador_frete'] = 1.2,				-- Multiplier applied when generating FREIGHT loads
	['probabilidade_ser_carga_urgente'] = 15,	-- The urgent load is generated randomly, here you can configure the probability (%)
...
Config.motoristas = {
	['cooldown'] = 15,							-- Cooldown time (in minutes) to generate a new driver
	['preco_por_km_min'] = 380,					-- Minimum starting price per KM of the driver (at the end of each delivery)
	['preco_por_km_max'] = 440,					-- Maximum initial price per KM of the driver (at the end of each delivery)
	...
	['max_motoristas_ativos'] = 5,				-- Maximum number of drivers that can be active, this means that when generating a driver that exceeds this number, the oldest driver will be deleted
...
Config.trabalhos = {
	...
	['valor_inicial_max'] = 10000,			-- Maximum initial contract profit

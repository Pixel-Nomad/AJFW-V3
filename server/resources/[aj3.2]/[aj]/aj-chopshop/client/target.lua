Citizen.CreateThread(function()
  ...
  elseif Config.Target == "berkie" then
    exports['berkie-target']:AddBoxZone("ChopShopParts", vector3(1208.73, -3114.35, 5.55), 1.40, 1.35, {
      name="ChopShopParts",
      heading=113.1992,
      debugPoly=false,
      minZ=28.77834,
    ...
    elseif Config.Target == "bt" then
      exports['bt-target']:AddBoxZone("ChopShopParts", vector3(1208.73, -3114.35, 5.55), 1.40, 1.35, {
        name="ChopShopParts",
        heading=113.1992,
        debugPoly=false,
        minZ=28.77834,

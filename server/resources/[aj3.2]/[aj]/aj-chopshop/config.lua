...
Config.StartLoc = vector4(1764.66, 3320.4, 41.43, 114.04)  -- Starting Location with target and PED

Config.WheelItems = {      -- Items you get when chopping a wheel
    [1] = {
        ["item"] = "aluminum",
        ["amount"] = math.random(4, 10)
    },
    [2] = {
        ["item"] = "rubber",
        ["amount"] = math.random(4, 10)
...
Config.VehicleCoords = {        -- Locations of where the vehicle can spawn **Chosen from random every time you start a new job**
    ...
    [7] = {coords = vector4(-1658.969, -205.1732, 54.8448, 71.138)},
    ...
    [42] = {coords = vector4(14.09792, 548.8402, 175.7571, 241.4019775)},
    ...
    [59] = {coords = vector4(78.38569, -198.4182, 55.79539, 70.1377)},

                        ...
                        if IsControlJustReleased(0, 38) then
                            ...
                            AJFW.Functions.TriggerCallback('AJFW:HasItem', function(result)
                                if result then
                                    ...
                                    AJFW.Functions.Notify("You don't have empty_bottle", "error")
                                end
...
function beerFilling()
    ...
    TriggerServerEvent("AJFW:Server:RemoveItem", "empty_bottle", 1)
    TriggerEvent("inventory:client:ItemBox", AJFW.Shared.Items["empty_bottle"], "remove")
    TriggerServerEvent("InteractSound_SV:PlayOnSource", "sodaop", 0.8)
    AJFW.Functions.Progressbar("empty_bottle", "Filling Beer in Bottle..",'orange', 8000, false, true, {
        ...
        TriggerServerEvent("AJFW:Server:AddItem", "beer", 1)
        TriggerEvent("inventory:client:ItemBox", AJFW.Shared.Items["beer"], "add")
    end, function() -- Cancel
        StopAnimTask(PlayerPedId(), "amb@prop_human_bum_shopping_cart@male@idle_a", "idle_c", 1.0)

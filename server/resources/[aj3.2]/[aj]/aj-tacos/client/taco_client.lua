...
function FinishTaco()
	...
	AJFW.Functions.Progressbar("pickup_sla", "Making taco..",'orange', 3500, false, true, {
...
function BakeMeat()
	...
	AJFW.Functions.Progressbar("pickup_sla", "Baking meat..",'red', 5000, false, true, {
		disableMovement = true,
		disableCarMovement = false,
		disableMouse = false,
		disableCombat = false,
...
function GetLettuce()
	...
	AJFW.Functions.Progressbar("pickup_sla", "Grabbing lettuce..",'green', 4100, false, true, {
		disableMovement = true,
		disableCarMovement = false,
		disableMouse = false,
		disableCombat = false,
...
function TakeMoney()
	if Config.JobData['register'] >= 10000 then
		...
		AJFW.Functions.Progressbar("search_register", "Empty cash register..",'purple', lockpickTime, false, true, {
            disableMovement = true,

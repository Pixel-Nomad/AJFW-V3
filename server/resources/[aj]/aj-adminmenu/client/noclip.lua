...
ToggleNoClip = function(state)
    ...
    AJFW.Functions.Notify(IsNoClipping and Lang:t('success.noclip_enabled') or Lang:t('success.noclip_disabled'))
...
RegisterNetEvent('aj-admin:client:ToggleNoClip', function()

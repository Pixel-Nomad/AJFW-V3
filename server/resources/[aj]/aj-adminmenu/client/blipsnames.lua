...
CreateThread(function()
    while true do
        ...
        if NetCheck1 or NetCheck2 then
            TriggerServerEvent('aj-admin:server:GetPlayersForBlips')
        end
    end
end)

RegisterNetEvent('aj-admin:client:toggleBlips', function()
...
RegisterNetEvent('aj-admin:client:toggleNames', function()

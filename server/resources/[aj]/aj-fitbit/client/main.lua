...
RegisterNetEvent('aj-fitbit:use', function()
    openWatch()
end)
...
RegisterNUICallback('setFoodWarning', function(data, cb)
    ...
    TriggerServerEvent('aj-fitbit:server:setValue', 'food', foodValue)
    AJFW.Functions.Notify(Lang:t('success.hunger_set', {hungervalue = foodValue}), 'success')
    cb('ok')
end)

RegisterNUICallback('setThirstWarning', function(data, cb)
    local thirstValue = tonumber(data.value)
    TriggerServerEvent('aj-fitbit:server:setValue', 'thirst', thirstValue)
    AJFW.Functions.Notify(Lang:t('success.thirst_set', {thirstvalue = thirstValue}), 'success')
    cb('ok')
end)
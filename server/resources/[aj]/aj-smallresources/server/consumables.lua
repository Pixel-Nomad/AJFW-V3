...
local function createItem(name, type)
    AJFW.Functions.CreateUseableItem(name, function(source, item)
        local Player = AJFW.Functions.GetPlayer(source)
        if not Player.Functions.RemoveItem(item.name, 1, item.slot) then return end
...
AJFW.Functions.CreateUseableItem('joint', function(source, item)
    local Player = AJFW.Functions.GetPlayer(source)
    if not Player.Functions.RemoveItem(item.name, 1, item.slot) then return end
    TriggerClientEvent('consumables:client:UseJoint', source)
end)

AJFW.Functions.CreateUseableItem('cokebaggy', function(source)
    TriggerClientEvent('consumables:client:Cokebaggy', source)
end)

AJFW.Functions.CreateUseableItem('crack_baggy', function(source)
    TriggerClientEvent('consumables:client:Crackbaggy', source)
end)

AJFW.Functions.CreateUseableItem('xtcbaggy', function(source)
    TriggerClientEvent('consumables:client:EcstasyBaggy', source)
end)

AJFW.Functions.CreateUseableItem('oxy', function(source)
    TriggerClientEvent('consumables:client:oxy', source)
end)

AJFW.Functions.CreateUseableItem('meth', function(source)
...
AJFW.Functions.CreateUseableItem('heavyarmor', function(source)
...
AJFW.Functions.CreateUseableItem('binoculars', function(source)
    TriggerClientEvent('binoculars:Toggle', source)
end)

AJFW.Functions.CreateUseableItem('parachute', function(source, item)
    local Player = AJFW.Functions.GetPlayer(source)
    if not Player.Functions.RemoveItem(item.name, 1, item.slot) then return end
    TriggerClientEvent('consumables:client:UseParachute', source)
end)

AJFW.Commands.Add('resetparachute', 'Resets Parachute', {}, false, function(source)
    TriggerClientEvent('consumables:client:ResetParachute', source)
end)

RegisterNetEvent('aj-smallpenis:server:AddParachute', function()
    local Player = AJFW.Functions.GetPlayer(source)
...
for _, v in pairs(Config.Fireworks.items) do
    AJFW.Functions.CreateUseableItem(v, function(source, item)
        local src = source
...
RegisterNetEvent('consumables:server:useHeavyArmor', function()
    ...
    TriggerClientEvent('inventory:client:ItemBox', source, AJFW.Shared.Items['heavyarmor'], 'remove')
...
RegisterNetEvent('consumables:server:useArmor', function()
    ...
    TriggerClientEvent('inventory:client:ItemBox', source, AJFW.Shared.Items['armor'], 'remove')
...
AJFW.Functions.CreateCallback('consumables:itemdata', function(_, cb, itemName)

...
Config.Discord = {
    ...
    applicationId = '1256769045953384488',                   -- The discord application id
    iconLarge = 'big',                               -- The name of the large icon
    iconLargeHoverText = 'Oxford Roleplay', -- The hover text of the large icon
    iconSmall = 'small',                         -- The name of the small icon
    iconSmallHoverText = 'UwU', -- The hover text of the small icon
    ...
    buttons = {
        ...
        {
            text = 'Join Discord',
            url = 'https://discord.gg/FahMruHq6B'
        }
    }
}

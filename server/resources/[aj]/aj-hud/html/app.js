...
function restartHud() {
    closeMenu();
    $.post("https://aj-hud/restartHud");
}
function resetStorage() {
    closeMenu();
    $.post("https://aj-hud/resetStorage");
}
function showOutMap() {
    $.post("https://aj-hud/showOutMap");
}
function showOutCompass() {
    $.post("https://aj-hud/showOutCompass");
}
function showFollowCompass() {
    $.post("https://aj-hud/showFollowCompass");
}
function openMenuSounds() {
    $.post("https://aj-hud/openMenuSounds");
}
function resetHudSounds() {
    $.post("https://aj-hud/resetHudSounds");
}
function checklistSounds() {
    $.post("https://aj-hud/checklistSounds");
}
function showMapNotif() {
    $.post("https://aj-hud/showMapNotif");
}
function showFuelAlert() {
    $.post("https://aj-hud/showFuelAlert");
}
function showCinematicNotif() {
    $.post("https://aj-hud/showCinematicNotif");
}
function dynamicHealth() {
    $.post("https://aj-hud/dynamicHealth");
}
function dynamicArmor() {
    $.post("https://aj-hud/dynamicArmor");
}
function dynamicHunger() {
    $.post("https://aj-hud/dynamicHunger");
}
function dynamicThirst() {
    $.post("https://aj-hud/dynamicThirst");
}
function dynamicStress() {
    $.post("https://aj-hud/dynamicStress");
}
function dynamicOxygen() {
    $.post("https://aj-hud/dynamicOxygen");
}
function dynamicEngine() {
    $.post("https://aj-hud/dynamicEngine");
}
function dynamicNitro() {
    $.post("https://aj-hud/dynamicNitro");
}
function ToggleMapShape() {
    $.post("https://aj-hud/ToggleMapShape");
}
function changeFPS() {
    $.post("https://aj-hud/changeFPS");
}
function ToggleMapBorders() {
    $.post("https://aj-hud/ToggleMapBorders");
}
function HideMap() {
    $.post("https://aj-hud/HideMap");
}
function changeCompassFPS() {
    $.post("https://aj-hud/changeCompassFPS");
}
function showCompassBase() {
    $.post("https://aj-hud/showCompassBase");
}
function showStreetsNames() {
    $.post("https://aj-hud/showStreetsNames");
}
function showPointerIndex() {
    $.post("https://aj-hud/showPointerIndex");
}
function showDegreesNum() {
    $.post("https://aj-hud/showDegreesNum");
}
function cinematicMode() {
    $.post("https://aj-hud/cinematicMode");
}

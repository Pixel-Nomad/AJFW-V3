...
$(document).on('click', '#whatsapp-openedchat-send', function(e){
    ...
    if (Message !== null && Message !== undefined && Message !== "") {
        $.post('https://aj-phone/SendMessage', JSON.stringify({
        ...
        AJ.Phone.Notifications.Add("fab fa-whatsapp", "Whatsapp", "You can't send a empty message!", "#25D366", 1750);
    }
});
...
AJ.Phone.Functions.SetupChatMessages = function(cData, NewChatData) {
    if (cData) {
        ...
        if (OpenedChatPicture == null) {
            $.post('https://aj-phone/GetProfilePicture', JSON.stringify({
...
$(document).on('click', '.whatsapp-shared-location', function(e){
    ...
    $.post('https://aj-phone/SharedLocation', JSON.stringify({

...
$(document).on('click', '.mail', function(e){
    ...
    AJ.Phone.Functions.SetupMail(MailData);
...
$(document).on('click', '#accept-mail', function(e){
    ...
    $.post('https://aj-phone/AcceptMailButton', JSON.stringify({
...
AJ.Phone.Functions.SetupMails = function(Mails) {
    ...
    $("#mail-header-mail").html(AJ.Phone.Data.PlayerData.charinfo.firstname+"."+AJ.Phone.Data.PlayerData.charinfo.lastname+"@ajfw.com");
...
AJ.Phone.Functions.SetupMail = function(MailData) {
...
$(document).on('click','#new-advert-photo',function(e){
    e.preventDefault();
    $.post('https://aj-phone/TakePhoto',function(url){
        if(url){
...
$(document).on('click', '#new-advert-submit', function(e){
    ...
    if (Advert !== "") {
        ...
        if (!picture){
            $.post('https://aj-phone/PostAdvert', JSON.stringify({
                message: Advert,
                url: null
            }));
        }else {
...
AJ.Phone.Functions.RefreshAdverts = function(Adverts) {
    $("#advert-header-name").html("@"+AJ.Phone.Data.PlayerData.charinfo.firstname+""+AJ.Phone.Data.PlayerData.charinfo.lastname+" | "+AJ.Phone.Data.PlayerData.charinfo.phone);

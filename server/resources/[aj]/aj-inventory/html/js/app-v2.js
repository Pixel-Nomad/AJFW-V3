    ...
    if (itemData != null && itemData.info != "") {
        ...
        if (itemData.name == "id_card") {
            ...
            $(".item-info-description").html(
                ...
                "</span></p><p style=\"font-size:11px\"><b>Weight: </b>" + itemData.weight + " | <b>Amount: </b> " + itemData.amount + " | <b>Quality: </b> " + "<a style=\"font-weight: bold;/* font-size:11px; */color: lime;\">" + Math.floor(itemData.info.quality) + "</a>"
            ...
            if (itemData.info.type == "casing") {
                ...
                $(".item-info-description").html(
                    ...
                    "</span></p><br /><p>" +
                    itemData.description +
                    "</p><p style=\"font-size:11px\"><b>Weight: </b>" + itemData.weight + " | <b>Amount: </b> " + itemData.amount + " | <b>Quality: </b> " + "<a style=\"font-weight: bold;/* font-size:11px; */color: lime;\">" + Math.floor(itemData.info.quality) + "</a>"
                );
            ...
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html("<p>" + itemData.info.costs + "</p><p style=\"font-size:11px\"><b>Weight: </b>" + itemData.weight + " | <b>Amount: </b> " + itemData.amount + " | <b>Quality: </b> " + "<a style=\"font-weight: bold;/* font-size:11px; */color: lime;\">" + Math.floor(itemData.info.quality) + "</a>");
        } else if (itemData.name == "stickynote") {
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html("<p>" + itemData.info.label + "</p><p style=\"font-size:11px\"><b>Weight: </b>" + itemData.weight + " | <b>Amount: </b> " + itemData.amount + " | <b>Quality: </b> " + "<a style=\"font-weight: bold;/* font-size:11px; */color: lime;\">" + Math.floor(itemData.info.quality) + "</a>");
            ...
            var cardNumber = "************" + res;
            $(".item-info-description").html('<p><strong>Card Holder: </strong><span>' + itemData.info.name + '</span></p><p><strong>Citizen ID: </strong><span>' + itemData.info.citizenid + '</span></p><p><strong>Card Number: </strong><span>' + cardNumber + '</span></p><p style=\"font-size:11px\"><b>Weight: </b>' + itemData.weight + " | <b>Amount: </b> " + itemData.amount + " | <b>Quality: </b> " + "<a style=\"font-weight: bold;/* font-size:11px; */color: lime;\">" + Math.floor(itemData.info.quality) + "</a>");
        } else if (itemData.name == "labkey") {
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html("<p>Lab: " + itemData.info.lab + "</p><p style=\"font-size:11px\"><b>Weight: </b>" + itemData.weight + " | <b>Amount: </b> " + itemData.amount + " | <b>Quality: </b> " + "<a style=\"font-weight: bold;/* font-size:11px; */color: lime;\">" + Math.floor(itemData.info.quality) + "</a>");
        } else if (
            ...
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html("<p>" + itemData.description + "</p><p style=\"font-size:11px\"><b>Weight: </b>" + itemData.weight + " | <b>Amount: </b> " + itemData.amount + " | <b>Quality: </b> " + "<a style=\"font-weight: bold;/* font-size:11px; */color: lime;\">" + Math.floor(itemData.info.quality) + "</a>" + "<p>Metadata Stored: " + itemData.metadata.length + "</p>");
        }
    } else {
        $(".item-info-title").html("<p>" + itemData.label + "</p>");
        $(".item-info-description").html("<p>" + itemData.description + "</p><p style=\"font-size:11px\"><b>Weight: </b>" + itemData.weight + " | <b>Amount: </b> " + itemData.amount + " | <b>Quality: </b> " + "<a style=\"font-weight: bold;/* font-size:11px; */color: lime;\">" + Math.floor(itemData.info.quality) + "</a>");
    }
}
...
$("#item-give").droppable({
    ...
    drop: function (event, ui) {
        ...
        // $.post(
        //     "https://aj-inventory/GetNearPlayers",
        //     JSON.stringify({
        //         inventory: fromInventory,
        //         item: fromData,
        //         amount: parseInt(amount),

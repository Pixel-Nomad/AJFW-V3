...
$(".cityhall-option-block").click(function (e) {
    ...
    if (blockPage == "identity") {
        ...
        $.post("https://aj-cityhall/requestLicenses", JSON.stringify({}), function (licenses) {
...
$(document).on("click", ".apply-job-button", function (e) {
    e.preventDefault();
    $.post("https://aj-cityhall/applyJob", JSON.stringify(selectedJobId));
    ResetPages();
});

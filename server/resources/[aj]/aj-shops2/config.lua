...
Config.Products = {
    ['normal'] = {
        {name = 'tosti',         price = 15,   amount = 300,   info = {}, type = 'item'},
        {name = 'water_bottle',  price = 10,   amount = 500,   info = {}, type = 'item'},
        {name = 'kurkakola',     price = 45,   amount = 500,  info = {}, type = 'item'},
        {name = 'twerks_candy',  price = 35,   amount = 500,   info = {}, type = 'item'},
        {name = 'snikkel_candy', price = 48,   amount = 500,   info = {}, type = 'item'},
        {name = 'sandwich',      price = 25,   amount = 500,   info = {}, type = 'item'},
        {name = 'bandage',       price = 100, amount = 5000,   info = {}, type = 'item'},
        -- {name = 'lighter',       price = 2,   amount = 50,   info = {}, type = 'item'},
        -- {name = 'rolling_paper', price = 2,   amount = 5000, info = {}, type = 'item'},
    },
    ['liquor'] = {
        {name = 'beer',    price = 70,  amount = 500, info = {}, type = 'item'},
        {name = 'whiskey', price = 100, amount = 500, info = {}, type = 'item'},
        {name = 'vodka',   price = 120, amount = 500, info = {}, type = 'item'},
    },
    ['hardware'] = {
        {name = 'lockpick',          price = 2000, amount = 50,  info = {}, type = 'item'},
        ...
        {name = 'phone',             price = 900, amount = 500,  info = {}, type = 'item'},
        {name = 'radio',             price = 1100, amount = 500,  info = {}, type = 'item'},
    ...
    ['leisureshop'] = {
        {name = 'parachute',   price = 2000, amount = 500, info = {}, type = 'item'},
        {name = 'binoculars',  price = 500,   amount = 500, info = {}, type = 'item'},
        {name = 'diving_gear', price = 3000, amount = 500, info = {}, type = 'item'},
        {name = 'diving_fill', price = 100,  amount = 500, info = {}, type = 'item'},
    },
    ['weapons'] = {
...
Config.Locations = {
    ...
    ['leisureshop'] = {
        ['label'] = 'Leisure Shop',
        ['coords'] = vector4(-1507.76, 1510.53, 114.29, 74.64),
        ['ped'] = 'a_m_y_beach_01',

...
RegisterNetEvent('aj-radialmenu:ResetClothing', ResetClothing)
...
RegisterNetEvent('aj-radialmenu:ToggleClothing', ToggleClothing)
...
RegisterNetEvent('aj-radialmenu:ToggleProps', ToggleProps)
...
function Notify(message, color) -- However you want your notifications to be shown, you can switch it up here.
	AJFW.Functions.Notify(message, color)
end

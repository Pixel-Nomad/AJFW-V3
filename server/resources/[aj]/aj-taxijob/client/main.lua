                ...
                if dist < 25 then
                    ...
                    if dist < 5 then
                        ...
                        if IsControlJustPressed(0, 38) then
                            ...
                            TriggerServerEvent('aj-taxi:server:NpcPay', meterData.currentFare)
                            meterActive = false
                            SendNUIMessage({
                                action = 'resetMeter'
                            })
...
RegisterNetEvent('aj-taxi:client:CancelTaxiNpc', function()
    if NpcData.Active then
        ...
        AJFW.Functions.Notify(Lang:t('success.mission_cancelled'), 'success')
    else
        AJFW.Functions.Notify(Lang:t('error.no_mission_active'), 'error')
    end
end)
